...
def show_balloon(title: str, text: str, icon: int = Icon.NONE) -> bool:
    return _TASK_BAR_ICON.SetIcon(_ICON, _APP.GetAppName()) and _TASK_BAR_ICON.ShowBalloon(title, text, flags=icon)
