...
class IContentLinkInfo(_inspectable.IInspectable):
    get_Id: _Callable[[_Pointer[_type.UINT32]],  # value
                      _type.HRESULT]
    put_Id: _Callable[[_type.UINT32],  # value
                      _type.HRESULT]
    ...
    put_Uri: _Callable[[_Windows_Foundation.IUriRuntimeClass],  # value
                       _type.HRESULT]
    get_LinkContentKind: _Callable[[_Pointer[_type.HSTRING]],  # value
                                   _type.HRESULT]
    put_LinkContentKind: _Callable[[_type.HSTRING],  # value
                                   _type.HRESULT]
...
class IRichEditTextRange(_inspectable.IInspectable):
    get_ContentLinkInfo: _Callable[[_Pointer[IContentLinkInfo]],  # value
                                   _type.HRESULT]
    put_ContentLinkInfo: _Callable[[IContentLinkInfo],  # value
                                   _type.HRESULT]


class ITextCharacterFormat(_inspectable.IInspectable):
    get_AllCaps: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                           _type.HRESULT]
    put_AllCaps: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                           _type.HRESULT]
    ...
    put_BackgroundColor: _Callable[[_struct.Windows.UI.Color],  # value
                                   _type.HRESULT]
    get_Bold: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                        _type.HRESULT]
    put_Bold: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                        _type.HRESULT]
    ...
    put_ForegroundColor: _Callable[[_struct.Windows.UI.Color],  # value
                                   _type.HRESULT]
    get_Hidden: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                          _type.HRESULT]
    put_Hidden: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                          _type.HRESULT]
    get_Italic: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                          _type.HRESULT]
    put_Italic: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                          _type.HRESULT]
    ...
    put_LanguageTag: _Callable[[_type.HSTRING],  # value
                               _type.HRESULT]
    get_LinkType: _Callable[[_Pointer[_enum.Windows.UI.Text.LinkType]],  # value
                            _type.HRESULT]
    get_Name: _Callable[[_Pointer[_type.HSTRING]],  # value
                        _type.HRESULT]
    put_Name: _Callable[[_type.HSTRING],  # value
                        _type.HRESULT]
    get_Outline: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                           _type.HRESULT]
    put_Outline: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                           _type.HRESULT]
    get_Position: _Callable[[_Pointer[_type.FLOAT]],  # value
                            _type.HRESULT]
    put_Position: _Callable[[_type.FLOAT],  # value
                            _type.HRESULT]
    get_ProtectedText: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                 _type.HRESULT]
    put_ProtectedText: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                 _type.HRESULT]
    get_Size: _Callable[[_Pointer[_type.FLOAT]],  # value
                        _type.HRESULT]
    put_Size: _Callable[[_type.FLOAT],  # value
                        _type.HRESULT]
    get_SmallCaps: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                             _type.HRESULT]
    put_SmallCaps: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                             _type.HRESULT]
    get_Spacing: _Callable[[_Pointer[_type.FLOAT]],  # value
                           _type.HRESULT]
    put_Spacing: _Callable[[_type.FLOAT],  # value
                           _type.HRESULT]
    get_Strikethrough: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                 _type.HRESULT]
    put_Strikethrough: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                 _type.HRESULT]
    get_Subscript: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                             _type.HRESULT]
    put_Subscript: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                             _type.HRESULT]
    get_Superscript: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                               _type.HRESULT]
    put_Superscript: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                               _type.HRESULT]
    get_TextScript: _Callable[[_Pointer[_enum.Windows.UI.Text.TextScript]],  # value
                              _type.HRESULT]
    put_TextScript: _Callable[[_enum.Windows.UI.Text.TextScript],  # value
                              _type.HRESULT]
    get_Underline: _Callable[[_Pointer[_enum.Windows.UI.Text.UnderlineType]],  # value
                             _type.HRESULT]
    put_Underline: _Callable[[_enum.Windows.UI.Text.UnderlineType],  # value
                             _type.HRESULT]
...
class ITextDocument(_inspectable.IInspectable):
    get_CaretType: _Callable[[_Pointer[_enum.Windows.UI.Text.CaretType]],  # value
                             _type.HRESULT]
    put_CaretType: _Callable[[_enum.Windows.UI.Text.CaretType],  # value
                             _type.HRESULT]
    ...
    GetRangeFromPoint: _Callable[[_struct.Windows.Foundation.Point,  # point
                                  _enum.Windows.UI.Text.PointOptions,  # options
                                  _Pointer[ITextRange]],  # result
                                 _type.HRESULT]
    GetText: _Callable[[_enum.Windows.UI.Text.TextGetOptions,  # options
                        _Pointer[_type.HSTRING]],  # value
                       _type.HRESULT]
    LoadFromStream: _Callable[[_enum.Windows.UI.Text.TextSetOptions,  # options
                               _Windows_Storage_Streams.IRandomAccessStream],  # value
                              _type.HRESULT]
    Redo: _Callable[[],
                    _type.HRESULT]
    SaveToStream: _Callable[[_enum.Windows.UI.Text.TextGetOptions,  # options
                             _Windows_Storage_Streams.IRandomAccessStream],  # value
                            _type.HRESULT]
    ...
    SetDefaultParagraphFormat: _Callable[[ITextParagraphFormat],  # value
                                         _type.HRESULT]
    SetText: _Callable[[_enum.Windows.UI.Text.TextSetOptions,  # options
                        _type.HSTRING],  # value
                       _type.HRESULT]
    Undo: _Callable[[],
                    _type.HRESULT]
...
class ITextDocument2(_inspectable.IInspectable):
...
class ITextDocument3(_inspectable.IInspectable):
    ClearUndoRedoHistory: _Callable[[],
                                    _type.HRESULT]


class ITextDocument4(_inspectable.IInspectable):
    SetMath: _Callable[[_type.HSTRING],  # value
                       _type.HRESULT]
    GetMath: _Callable[[_Pointer[_type.HSTRING]],  # value
                       _type.HRESULT]
    SetMathMode: _Callable[[_enum.Windows.UI.Text.RichEditMathMode],  # mode
                           _type.HRESULT]


class ITextParagraphFormat(_inspectable.IInspectable):
    get_Alignment: _Callable[[_Pointer[_enum.Windows.UI.Text.ParagraphAlignment]],  # value
                             _type.HRESULT]
    put_Alignment: _Callable[[_enum.Windows.UI.Text.ParagraphAlignment],  # value
                             _type.HRESULT]
    get_FirstLineIndent: _Callable[[_Pointer[_type.FLOAT]],  # value
                                   _type.HRESULT]
    get_KeepTogether: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                _type.HRESULT]
    put_KeepTogether: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                _type.HRESULT]
    get_KeepWithNext: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                _type.HRESULT]
    put_KeepWithNext: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                _type.HRESULT]
    get_LeftIndent: _Callable[[_Pointer[_type.FLOAT]],  # value
                              _type.HRESULT]
    get_LineSpacing: _Callable[[_Pointer[_type.FLOAT]],  # value
                               _type.HRESULT]
    get_LineSpacingRule: _Callable[[_Pointer[_enum.Windows.UI.Text.LineSpacingRule]],  # value
                                   _type.HRESULT]
    get_ListAlignment: _Callable[[_Pointer[_enum.Windows.UI.Text.MarkerAlignment]],  # value
                                 _type.HRESULT]
    put_ListAlignment: _Callable[[_enum.Windows.UI.Text.MarkerAlignment],  # value
                                 _type.HRESULT]
    ...
    put_ListStart: _Callable[[_type.INT32],  # value
                             _type.HRESULT]
    get_ListStyle: _Callable[[_Pointer[_enum.Windows.UI.Text.MarkerStyle]],  # value
                             _type.HRESULT]
    put_ListStyle: _Callable[[_enum.Windows.UI.Text.MarkerStyle],  # value
                             _type.HRESULT]
    get_ListTab: _Callable[[_Pointer[_type.FLOAT]],  # value
                           _type.HRESULT]
    put_ListTab: _Callable[[_type.FLOAT],  # value
                           _type.HRESULT]
    get_ListType: _Callable[[_Pointer[_enum.Windows.UI.Text.MarkerType]],  # value
                            _type.HRESULT]
    put_ListType: _Callable[[_enum.Windows.UI.Text.MarkerType],  # value
                            _type.HRESULT]
    get_NoLineNumber: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                _type.HRESULT]
    put_NoLineNumber: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                _type.HRESULT]
    get_PageBreakBefore: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                   _type.HRESULT]
    put_PageBreakBefore: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                   _type.HRESULT]
    get_RightIndent: _Callable[[_Pointer[_type.FLOAT]],  # value
                               _type.HRESULT]
    put_RightIndent: _Callable[[_type.FLOAT],  # value
                               _type.HRESULT]
    get_RightToLeft: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                               _type.HRESULT]
    put_RightToLeft: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                               _type.HRESULT]
    get_Style: _Callable[[_Pointer[_enum.Windows.UI.Text.ParagraphStyle]],  # value
                         _type.HRESULT]
    put_Style: _Callable[[_enum.Windows.UI.Text.ParagraphStyle],  # value
                         _type.HRESULT]
    ...
    put_SpaceBefore: _Callable[[_type.FLOAT],  # value
                               _type.HRESULT]
    get_WidowControl: _Callable[[_Pointer[_enum.Windows.UI.Text.FormatEffect]],  # value
                                _type.HRESULT]
    put_WidowControl: _Callable[[_enum.Windows.UI.Text.FormatEffect],  # value
                                _type.HRESULT]
    get_TabCount: _Callable[[_Pointer[_type.INT32]],  # value
                            _type.HRESULT]
    AddTab: _Callable[[_type.FLOAT,  # position
                       _enum.Windows.UI.Text.TabAlignment,  # align
                       _enum.Windows.UI.Text.TabLeader],  # leader
                      _type.HRESULT]
    ...
    GetTab: _Callable[[_type.INT32,  # index
                       ...
                       _Pointer[_enum.Windows.UI.Text.TabAlignment],  # align
                       _Pointer[_enum.Windows.UI.Text.TabLeader]],  # leader
                      _type.HRESULT]
    ...
    SetIndents: _Callable[[_type.FLOAT,  # start
                           ...
                           _type.FLOAT],  # right
                          _type.HRESULT]
    SetLineSpacing: _Callable[[_enum.Windows.UI.Text.LineSpacingRule,  # rule
                               _type.FLOAT],  # spacing
                              _type.HRESULT]
...
class ITextRange(_inspectable.IInspectable):
    ...
    put_EndPosition: _Callable[[_type.INT32],  # value
                               _type.HRESULT]
    get_Gravity: _Callable[[_Pointer[_enum.Windows.UI.Text.RangeGravity]],  # value
                           _type.HRESULT]
    put_Gravity: _Callable[[_enum.Windows.UI.Text.RangeGravity],  # value
                           _type.HRESULT]
    ...
    CanPaste: _Callable[[_type.INT32,  # format
                         _Pointer[_type.boolean]],  # result
                        _type.HRESULT]
    ChangeCase: _Callable[[_enum.Windows.UI.Text.LetterCase],  # value
                          _type.HRESULT]
    ...
    Cut: _Callable[[],
                   _type.HRESULT]
    Delete: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                       _type.INT32,  # count
                       _Pointer[_type.INT32]],  # result
                      _type.HRESULT]
    EndOf: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                      _type.boolean,  # extend
                      _Pointer[_type.INT32]],  # result
                     _type.HRESULT]
    Expand: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                       _Pointer[_type.INT32]],  # result
                      _type.HRESULT]
    FindText: _Callable[[_type.HSTRING,  # value
                         _type.INT32,  # scanLength
                         _enum.Windows.UI.Text.FindOptions,  # options
                         _Pointer[_type.INT32]],  # result
                        _type.HRESULT]
    ...
    GetClone: _Callable[[_Pointer[ITextRange]],  # result
                        _type.HRESULT]
    GetIndex: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                         _Pointer[_type.INT32]],  # result
                        _type.HRESULT]
    GetPoint: _Callable[[_enum.Windows.UI.Text.HorizontalCharacterAlignment,  # horizontalAlign
                         _enum.Windows.UI.Text.VerticalCharacterAlignment,  # verticalAlign
                         _enum.Windows.UI.Text.PointOptions,  # options
                         _Pointer[_struct.Windows.Foundation.Point]],  # point
                        _type.HRESULT]
    GetRect: _Callable[[_enum.Windows.UI.Text.PointOptions,  # options
    ...
    GetText: _Callable[[_enum.Windows.UI.Text.TextGetOptions,  # options
                        _Pointer[_type.HSTRING]],  # value
                       _type.HRESULT]
    GetTextViaStream: _Callable[[_enum.Windows.UI.Text.TextGetOptions,  # options
                                 _Windows_Storage_Streams.IRandomAccessStream],  # value
                                _type.HRESULT]
    ...
    IsEqual: _Callable[[ITextRange,  # range
                        _Pointer[_type.boolean]],  # result
                       _type.HRESULT]
    Move: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                     _type.INT32,  # count
                     _Pointer[_type.INT32]],  # result
                    _type.HRESULT]
    MoveEnd: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                        _type.INT32,  # count
                        _Pointer[_type.INT32]],  # result
                       _type.HRESULT]
    MoveStart: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                          _type.INT32,  # count
                          _Pointer[_type.INT32]],  # result
                         _type.HRESULT]
    Paste: _Callable[[_type.INT32],  # format
                     _type.HRESULT]
    ScrollIntoView: _Callable[[_enum.Windows.UI.Text.PointOptions],  # value
                              _type.HRESULT]
    MatchSelection: _Callable[[],
                              _type.HRESULT]
    SetIndex: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                         _type.INT32,  # index
                         _type.boolean],  # extend
                        _type.HRESULT]
    ...
    SetText: _Callable[[_enum.Windows.UI.Text.TextSetOptions,  # options
                        _type.HSTRING],  # value
                       _type.HRESULT]
    SetTextViaStream: _Callable[[_enum.Windows.UI.Text.TextSetOptions,  # options
                                 _Windows_Storage_Streams.IRandomAccessStream],  # value
                                _type.HRESULT]
    StartOf: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                        _type.boolean,  # extend
                        _Pointer[_type.INT32]],  # result
                       _type.HRESULT]
...
class ITextSelection(_inspectable.IInspectable):
    get_Options: _Callable[[_Pointer[_enum.Windows.UI.Text.SelectionOptions]],  # value
                           _type.HRESULT]
    put_Options: _Callable[[_enum.Windows.UI.Text.SelectionOptions],  # value
                           _type.HRESULT]
    get_Type: _Callable[[_Pointer[_enum.Windows.UI.Text.SelectionType]],  # value
                        _type.HRESULT]
    EndKey: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                       _type.boolean,  # extend
                       _Pointer[_type.INT32]],  # result
                      _type.HRESULT]
    HomeKey: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                        _type.boolean,  # extend
                        _Pointer[_type.INT32]],  # result
                       _type.HRESULT]
    MoveDown: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                         _type.INT32,  # count
                         _type.boolean,  # extend
                         _Pointer[_type.INT32]],  # result
                        _type.HRESULT]
    MoveLeft: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                         _type.INT32,  # count
                         _type.boolean,  # extend
                         _Pointer[_type.INT32]],  # result
                        _type.HRESULT]
    MoveRight: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                          _type.INT32,  # count
                          _type.boolean,  # extend
                          _Pointer[_type.INT32]],  # result
                         _type.HRESULT]
    MoveUp: _Callable[[_enum.Windows.UI.Text.TextRangeUnit,  # unit
                       _type.INT32,  # count
                       _type.boolean,  # extend
                       _Pointer[_type.INT32]],  # result
                      _type.HRESULT]
