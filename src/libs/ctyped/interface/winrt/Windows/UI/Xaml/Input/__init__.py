...
class IContextRequestedEventArgs(_inspectable.IInspectable):
    ...
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
    TryGetPosition: _Callable[[_Windows_UI_Xaml.IUIElement,  # relativeTo
...
class IDoubleTappedRoutedEventArgs(_inspectable.IInspectable):
    ...
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
    GetPosition: _Callable[[_Windows_UI_Xaml.IUIElement,  # relativeTo
...
class IFindNextElementOptions(_inspectable.IInspectable):
    get_SearchRoot: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyObject]],  # value
                              _type.HRESULT]
    put_SearchRoot: _Callable[[_Windows_UI_Xaml.IDependencyObject],  # value
                              _type.HRESULT]
    ...
    put_HintRect: _Callable[[_struct.Windows.Foundation.Rect],  # value
                            _type.HRESULT]
    get_XYFocusNavigationStrategyOverride: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Input.XYFocusNavigationStrategyOverride]],  # value
                                                     _type.HRESULT]
    put_XYFocusNavigationStrategyOverride: _Callable[[_enum.Windows.UI.Xaml.Input.XYFocusNavigationStrategyOverride],  # value
                                                     _type.HRESULT]
...
class IFocusManagerGotFocusEventArgs(_inspectable.IInspectable):
    get_NewFocusedElement: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyObject]],  # value
                                     _type.HRESULT]
...
class IFocusManagerLostFocusEventArgs(_inspectable.IInspectable):
    get_OldFocusedElement: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyObject]],  # value
                                     _type.HRESULT]
    get_CorrelationId: _Callable[[_Pointer[_struct.GUID]],  # value
                                 _type.HRESULT]
...
class IFocusManagerStatics3(_inspectable.IInspectable):
    FindNextFocusableElement: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
                                        ...
                                        _type.HRESULT]
    FindNextFocusableElementWithHint: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
...
class IFocusManagerStatics4(_inspectable.IInspectable):
    TryMoveFocusWithOptions: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
                                        ...
                                        _Pointer[_type.boolean]],  # result
                                       _type.HRESULT]
    FindNextElement: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
                                _Pointer[_Windows_UI_Xaml.IDependencyObject]],  # result
                               _type.HRESULT]
    FindFirstFocusableElement: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # searchScope
                                          _Pointer[_Windows_UI_Xaml.IDependencyObject]],  # result
                                         _type.HRESULT]
    FindLastFocusableElement: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # searchScope
                                         _Pointer[_Windows_UI_Xaml.IDependencyObject]],  # result
                                        _type.HRESULT]
    FindNextElementWithOptions: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
                                           IFindNextElementOptions,  # focusNavigationOptions
                                           _Pointer[_Windows_UI_Xaml.IDependencyObject]],  # result
                                          _type.HRESULT]
...
class IFocusManagerStatics5(_inspectable.IInspectable):
    TryFocusAsync: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # element
                             ...
                             _type.HRESULT]
    TryMoveFocusAsync: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
                                  _Pointer[_Windows_Foundation.IAsyncOperation[IFocusMovementResult]]],  # operation
                                 _type.HRESULT]
    TryMoveFocusWithOptionsAsync: _Callable[[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection,  # focusNavigationDirection
                                             IFindNextElementOptions,  # focusNavigationOptions
                                             _Pointer[_Windows_Foundation.IAsyncOperation[IFocusMovementResult]]],  # operation
                                            _type.HRESULT]
...
class IGettingFocusEventArgs(_inspectable.IInspectable):
    ...
    get_NewFocusedElement: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyObject]],  # value
                                     _type.HRESULT]
    put_NewFocusedElement: _Callable[[_Windows_UI_Xaml.IDependencyObject],  # value
                                     _type.HRESULT]
    get_FocusState: _Callable[[_Pointer[_enum.Windows.UI.Xaml.FocusState]],  # value
                              _type.HRESULT]
    get_Direction: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Input.FocusNavigationDirection]],  # value
                             _type.HRESULT]
    get_Handled: _Callable[[_Pointer[_type.boolean]],  # value
                           _type.HRESULT]
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
    get_InputDevice: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Input.FocusInputDeviceKind]],  # value
                               _type.HRESULT]
...
class IGettingFocusEventArgs2(_inspectable.IInspectable):
    TryCancel: _Callable[[_Pointer[_type.boolean]],  # result
                         _type.HRESULT]
    TrySetNewFocusedElement: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # element
                                        _Pointer[_type.boolean]],  # result
                                       _type.HRESULT]


class IGettingFocusEventArgs3(_inspectable.IInspectable):
    get_CorrelationId: _Callable[[_Pointer[_struct.GUID]],  # value
                                 _type.HRESULT]
...
class IInputScopeName(_inspectable.IInspectable):
    get_NameValue: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Input.InputScopeNameValue]],  # value
                             _type.HRESULT]
    put_NameValue: _Callable[[_enum.Windows.UI.Xaml.Input.InputScopeNameValue],  # value
                             _type.HRESULT]
...
class IKeyRoutedEventArgs2(_inspectable.IInspectable):
    get_OriginalKey: _Callable[[_Pointer[_enum.Windows.System.VirtualKey]],  # value
                               _type.HRESULT]


class IKeyRoutedEventArgs3(_inspectable.IInspectable):
...
class IKeyboardAccelerator(_inspectable.IInspectable):
    ...
    put_IsEnabled: _Callable[[_type.boolean],  # value
                             _type.HRESULT]
    get_ScopeOwner: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyObject]],  # value
                              _type.HRESULT]
    put_ScopeOwner: _Callable[[_Windows_UI_Xaml.IDependencyObject],  # value
                              _type.HRESULT]
...
class IKeyboardAcceleratorInvokedEventArgs(_inspectable.IInspectable):
    ...
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
    get_Element: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyObject]],  # value
                           _type.HRESULT]


class IKeyboardAcceleratorInvokedEventArgs2(_inspectable.IInspectable):
...
class ILosingFocusEventArgs2(_inspectable.IInspectable):
    TryCancel: _Callable[[_Pointer[_type.boolean]],  # result
                         _type.HRESULT]
    TrySetNewFocusedElement: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # element
                                        _Pointer[_type.boolean]],  # result
...
class ILosingFocusEventArgs3(_inspectable.IInspectable):
    get_CorrelationId: _Callable[[_Pointer[_struct.GUID]],  # value
                                 _type.HRESULT]


class IManipulationCompletedRoutedEventArgs(_inspectable.IInspectable):
    get_Container: _Callable[[_Pointer[_Windows_UI_Xaml.IUIElement]],  # value
                             _type.HRESULT]
...
class IManipulationStartingRoutedEventArgs(_inspectable.IInspectable):
    get_Mode: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Input.ManipulationModes]],  # value
                        _type.HRESULT]
    put_Mode: _Callable[[_enum.Windows.UI.Xaml.Input.ManipulationModes],  # value
                        _type.HRESULT]
    get_Container: _Callable[[_Pointer[_Windows_UI_Xaml.IUIElement]],  # value
                             _type.HRESULT]
    put_Container: _Callable[[_Windows_UI_Xaml.IUIElement],  # value
                             _type.HRESULT]
...
class IPointerRoutedEventArgs(_inspectable.IInspectable):
    ...
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
    GetCurrentPoint: _Callable[[_Windows_UI_Xaml.IUIElement,  # relativeTo
                                _Pointer[_Windows_UI_Input.IPointerPoint]],  # result
                               _type.HRESULT]
    GetIntermediatePoints: _Callable[[_Windows_UI_Xaml.IUIElement,  # relativeTo
                                      _Pointer[_Windows_Foundation_Collections.IVector[_Windows_UI_Input.IPointerPoint]]],  # result
                                     _type.HRESULT]


class IPointerRoutedEventArgs2(_inspectable.IInspectable):
...
class IStandardUICommand(_inspectable.IInspectable):
    get_Kind: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Input.StandardUICommandKind]],  # value
                        _type.HRESULT]


class IStandardUICommand2(_inspectable.IInspectable):
    put_Kind: _Callable[[_enum.Windows.UI.Xaml.Input.StandardUICommandKind],  # value
                        _type.HRESULT]
...
class IStandardUICommandFactory(_inspectable.IInspectable):
    CreateInstance: _Callable[[_inspectable.IInspectable,  # baseInterface
                              ...
                              _type.HRESULT]
    CreateInstanceWithKind: _Callable[[_enum.Windows.UI.Xaml.Input.StandardUICommandKind,  # kind
...
class IXamlUICommand(_inspectable.IInspectable):
    ...
    put_Label: _Callable[[_type.HSTRING],  # value
                         _type.HRESULT]
    get_IconSource: _Callable[[_Pointer[_Windows_UI_Xaml_Controls.IIconSource]],  # value
                              _type.HRESULT]
    put_IconSource: _Callable[[_Windows_UI_Xaml_Controls.IIconSource],  # value
                              _type.HRESULT]
...
class IXamlUICommandStatics(_inspectable.IInspectable):
    ...
    get_IconSourceProperty: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyProperty]],  # value
                                      _type.HRESULT]
    get_KeyboardAcceleratorsProperty: _Callable[[_Pointer[_Windows_UI_Xaml.IDependencyProperty]],  # value
                                                _type.HRESULT]
