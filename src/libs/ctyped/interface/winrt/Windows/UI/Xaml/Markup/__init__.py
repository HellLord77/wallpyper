...
class IComponentConnector2(_inspectable.IInspectable):
...
class IXamlBindingHelperStatics(_inspectable.IInspectable):
    ...
    GetDataTemplateComponent: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # element
                                        ...
                                        _type.HRESULT]
    SetDataTemplateComponent: _Callable[[_Windows_UI_Xaml.IDependencyObject,  # element
                                         IDataTemplateComponent],  # value
                                        _type.HRESULT]
    SuspendRendering: _Callable[[_Windows_UI_Xaml.IUIElement],  # target
                                _type.HRESULT]
    ResumeRendering: _Callable[[_Windows_UI_Xaml.IUIElement],  # target
                               _type.HRESULT]
    ...
    SetPropertyFromString: _Callable[[_inspectable.IInspectable,  # dependencyObject
                                      _Windows_UI_Xaml.IDependencyProperty,  # propertyToSet
                                      _type.HSTRING],  # value
                                     _type.HRESULT]
...
class IXamlMetadataProvider(_inspectable.IInspectable):
    ...
    GetXmlnsDefinitions: _Callable[[_Pointer[_type.UINT32],  # __resultSize
                                    _Pointer[_Pointer[_struct.Windows.UI.Xaml.Markup.XmlnsDefinition]]],  # result
                                   _type.HRESULT]
...
class IXamlType2(_inspectable.IInspectable):
