...
class ICustomNavigationProvider(_inspectable.IInspectable):
    NavigateCustom: _Callable[[_enum.Windows.UI.Xaml.Automation.Peers.AutomationNavigationDirection,  # direction
                               _Pointer[_inspectable.IInspectable]],  # result
                              _type.HRESULT]


class IDockProvider(_inspectable.IInspectable):
    get_DockPosition: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.DockPosition]],  # value
                                _type.HRESULT]
    SetDockPosition: _Callable[[_enum.Windows.UI.Xaml.Automation.DockPosition],  # dockPosition
                               _type.HRESULT]
...
class IExpandCollapseProvider(_inspectable.IInspectable):
    get_ExpandCollapseState: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.ExpandCollapseState]],  # value
                                       _type.HRESULT]
    Collapse: _Callable[[],
                        _type.HRESULT]
    Expand: _Callable[[],
...
class IItemContainerProvider(_inspectable.IInspectable):
    FindItemByProperty: _Callable[[IIRawElementProviderSimple,  # startAfter
                                   _Windows_UI_Xaml_Automation.IAutomationProperty,  # automationProperty
...
class IScrollProvider(_inspectable.IInspectable):
    ...
    get_VerticalViewSize: _Callable[[_Pointer[_type.DOUBLE]],  # value
                                    _type.HRESULT]
    Scroll: _Callable[[_enum.Windows.UI.Xaml.Automation.ScrollAmount,  # horizontalAmount
                       _enum.Windows.UI.Xaml.Automation.ScrollAmount],  # verticalAmount
                      _type.HRESULT]
...
class ISpreadsheetItemProvider(_inspectable.IInspectable):
    ...
    GetAnnotationTypes: _Callable[[_Pointer[_type.UINT32],  # __resultSize
                                   _Pointer[_Pointer[_enum.Windows.UI.Xaml.Automation.AnnotationType]]],  # result
                                  _type.HRESULT]
...
class ISynchronizedInputProvider(_inspectable.IInspectable):
    Cancel: _Callable[[],
                      _type.HRESULT]
    StartListening: _Callable[[_enum.Windows.UI.Xaml.Automation.SynchronizedInputType],  # inputType
                              _type.HRESULT]
...
class ITableProvider(_inspectable.IInspectable):
    get_RowOrColumnMajor: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.RowOrColumnMajor]],  # value
                                    _type.HRESULT]
...
class ITextProvider(_inspectable.IInspectable):
    get_DocumentRange: _Callable[[_Pointer[ITextRangeProvider]],  # value
                                 _type.HRESULT]
    get_SupportedTextSelection: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.SupportedTextSelection]],  # value
                                          _type.HRESULT]
    GetSelection: _Callable[[_Pointer[_type.UINT32],  # __resultSize
...
class ITextRangeProvider(_inspectable.IInspectable):
    ...
    Compare: _Callable[[ITextRangeProvider,  # textRangeProvider
                       ...
                       _type.HRESULT]
    CompareEndpoints: _Callable[[_enum.Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint,  # endpoint
                                 ITextRangeProvider,  # textRangeProvider
                                 _enum.Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint,  # targetEndpoint
                                 _Pointer[_type.INT32]],  # result
                                _type.HRESULT]
    ExpandToEnclosingUnit: _Callable[[_enum.Windows.UI.Xaml.Automation.Text.TextUnit],  # unit
                                     _type.HRESULT]
    ...
    GetText: _Callable[[_type.INT32,  # maxLength
                        _Pointer[_type.HSTRING]],  # result
                       _type.HRESULT]
    Move: _Callable[[_enum.Windows.UI.Xaml.Automation.Text.TextUnit,  # unit
                     _type.INT32,  # count
                     _Pointer[_type.INT32]],  # result
                    _type.HRESULT]
    MoveEndpointByUnit: _Callable[[_enum.Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint,  # endpoint
                                   _enum.Windows.UI.Xaml.Automation.Text.TextUnit,  # unit
                                   _type.INT32,  # count
                                   _Pointer[_type.INT32]],  # result
                                  _type.HRESULT]
    MoveEndpointByRange: _Callable[[_enum.Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint,  # endpoint
                                    ITextRangeProvider,  # textRangeProvider
                                    _enum.Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint],  # targetEndpoint
                                   _type.HRESULT]
    Select: _Callable[[],
...
class IToggleProvider(_inspectable.IInspectable):
    get_ToggleState: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.ToggleState]],  # value
                               _type.HRESULT]
    Toggle: _Callable[[],
                      _type.HRESULT]
...
class ITransformProvider2(_inspectable.IInspectable):
    ...
    Zoom: _Callable[[_type.DOUBLE],  # zoom
                    _type.HRESULT]
    ZoomByUnit: _Callable[[_enum.Windows.UI.Xaml.Automation.ZoomUnit],  # zoomUnit
                          _type.HRESULT]
...
class IWindowProvider(_inspectable.IInspectable):
    ...
    get_Minimizable: _Callable[[_Pointer[_type.boolean]],  # value
                               _type.HRESULT]
    get_InteractionState: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.WindowInteractionState]],  # value
                                    _type.HRESULT]
    get_VisualState: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Automation.WindowVisualState]],  # value
                               _type.HRESULT]
    Close: _Callable[[],
                     _type.HRESULT]
    SetVisualState: _Callable[[_enum.Windows.UI.Xaml.Automation.WindowVisualState],  # state
                              _type.HRESULT]
