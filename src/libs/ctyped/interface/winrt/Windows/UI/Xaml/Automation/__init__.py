...
class IAnnotationPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IAutomationAnnotationFactory(_inspectable.IInspectable):
...
class IAutomationAnnotationStatics(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics2(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics3(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics4(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics5(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics6(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics7(_inspectable.IInspectable):
...
class IAutomationElementIdentifiersStatics8(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics2(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics3(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics4(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics5(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics6(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics7(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics8(_inspectable.IInspectable):
...
class IAutomationPropertiesStatics9(_inspectable.IInspectable):
...
class IDockPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IDragPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IDropTargetPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IExpandCollapsePatternIdentifiersStatics(_inspectable.IInspectable):
...
class IGridItemPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IGridPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IMultipleViewPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IRangeValuePatternIdentifiersStatics(_inspectable.IInspectable):
...
class IScrollPatternIdentifiersStatics(_inspectable.IInspectable):
...
class ISelectionItemPatternIdentifiersStatics(_inspectable.IInspectable):
...
class ISelectionPatternIdentifiersStatics(_inspectable.IInspectable):
...
class ISpreadsheetItemPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IStylesPatternIdentifiersStatics(_inspectable.IInspectable):
...
class ITableItemPatternIdentifiersStatics(_inspectable.IInspectable):
...
class ITablePatternIdentifiersStatics(_inspectable.IInspectable):
...
class ITogglePatternIdentifiersStatics(_inspectable.IInspectable):
...
class ITransformPattern2IdentifiersStatics(_inspectable.IInspectable):
...
class ITransformPatternIdentifiersStatics(_inspectable.IInspectable):
...
class IValuePatternIdentifiersStatics(_inspectable.IInspectable):
    get_IsReadOnlyProperty: _Callable[[_Pointer[IAutomationProperty]],  # value
                                      _type.HRESULT]
    get_ValueProperty: _Callable[[_Pointer[IAutomationProperty]],  # value
                                 _type.HRESULT]
...
class IWindowPatternIdentifiersStatics(_inspectable.IInspectable):
