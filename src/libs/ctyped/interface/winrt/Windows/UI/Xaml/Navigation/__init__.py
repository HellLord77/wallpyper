...
class _ILoadCompletedEventHandler:
    Invoke: _Callable[[_inspectable.IInspectable,  # sender
                       INavigationEventArgs],  # e
                      _type.HRESULT]


class ILoadCompletedEventHandler(_ILoadCompletedEventHandler, _Unknwnbase.IUnknown):
    pass


# noinspection PyPep8Naming
class ILoadCompletedEventHandler_impl(_ILoadCompletedEventHandler, _Unknwnbase.IUnknown_impl):
    pass
...
class IFrameNavigationOptions(_inspectable.IInspectable):
    ...
    put_IsNavigationStackEnabled: _Callable[[_type.boolean],  # value
                                            _type.HRESULT]
    get_TransitionInfoOverride: _Callable[[_Pointer[_Windows_UI_Xaml_Media_Animation.INavigationTransitionInfo]],  # value
                                          _type.HRESULT]
    put_TransitionInfoOverride: _Callable[[_Windows_UI_Xaml_Media_Animation.INavigationTransitionInfo],  # value
                                          _type.HRESULT]
...
class INavigatingCancelEventArgs(_inspectable.IInspectable):
    ...
    put_Cancel: _Callable[[_type.boolean],  # value
                          _type.HRESULT]
    get_NavigationMode: _Callable[[_Pointer[_enum.Windows.UI.Xaml.Navigation.NavigationMode]],  # value
                                  _type.HRESULT]
    get_SourcePageType: _Callable[[_Pointer[_struct.Windows.UI.Xaml.Interop.TypeName]],  # value
                                  _type.HRESULT]


class INavigatingCancelEventArgs2(_inspectable.IInspectable):
    get_Parameter: _Callable[[_Pointer[_inspectable.IInspectable]],  # value
                             _type.HRESULT]
    get_NavigationTransitionInfo: _Callable[[_Pointer[_Windows_UI_Xaml_Media_Animation.INavigationTransitionInfo]],  # value
                                            _type.HRESULT]
...
class INavigationEventArgs2(_inspectable.IInspectable):
    get_NavigationTransitionInfo: _Callable[[_Pointer[_Windows_UI_Xaml_Media_Animation.INavigationTransitionInfo]],  # value
                                            _type.HRESULT]
