...
class ICompositionConditionalValue(_inspectable.IInspectable):
    get_Condition: _Callable[[_Pointer[_Windows_UI_Composition.IExpressionAnimation]],  # value
                             _type.HRESULT]
    put_Condition: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                             _type.HRESULT]
    get_Value: _Callable[[_Pointer[_Windows_UI_Composition.IExpressionAnimation]],  # value
                         _type.HRESULT]
    put_Value: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                         _type.HRESULT]
...
class IInteractionSourceConfiguration(_inspectable.IInspectable):
    get_PositionXSourceMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionSourceRedirectionMode]],  # value
                                       _type.HRESULT]
    put_PositionXSourceMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionSourceRedirectionMode],  # value
                                       _type.HRESULT]
    get_PositionYSourceMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionSourceRedirectionMode]],  # value
                                       _type.HRESULT]
    put_PositionYSourceMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionSourceRedirectionMode],  # value
                                       _type.HRESULT]
    get_ScaleSourceMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionSourceRedirectionMode]],  # value
                                   _type.HRESULT]
    put_ScaleSourceMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionSourceRedirectionMode],  # value
                                   _type.HRESULT]
...
class IInteractionTracker(_inspectable.IInspectable):
    ...
    TryUpdatePositionBy: _Callable[[_struct.Windows.Foundation.Numerics.Vector3,  # amount
                                    _Pointer[_type.INT32]],  # result
                                   _type.HRESULT]
    TryUpdatePositionWithAnimation: _Callable[[_Windows_UI_Composition.ICompositionAnimation,  # animation
                                               _Pointer[_type.INT32]],  # result
                                              _type.HRESULT]
    ...
    TryUpdateScale: _Callable[[_type.FLOAT,  # value
                               ...
                               _Pointer[_type.INT32]],  # result
                              _type.HRESULT]
    TryUpdateScaleWithAnimation: _Callable[[_Windows_UI_Composition.ICompositionAnimation,  # animation
                                            _struct.Windows.Foundation.Numerics.Vector3,  # centerPoint
                                            _Pointer[_type.INT32]],  # result
                                           _type.HRESULT]
...
class IInteractionTracker4(_inspectable.IInspectable):
    TryUpdatePositionWithOption: _Callable[[_struct.Windows.Foundation.Numerics.Vector3,  # value
                                            _enum.Windows.UI.Composition.Interactions.InteractionTrackerClampingOption,  # option
                                            _Pointer[_type.INT32]],  # result
                                           _type.HRESULT]
...
class IInteractionTracker5(_inspectable.IInspectable):
    TryUpdatePositionWithOption: _Callable[[_struct.Windows.Foundation.Numerics.Vector3,  # value
                                            _enum.Windows.UI.Composition.Interactions.InteractionTrackerClampingOption,  # option
                                            _enum.Windows.UI.Composition.Interactions.InteractionTrackerPositionUpdateOption,  # posUpdateOption
                                            _Pointer[_type.INT32]],  # result
                                           _type.HRESULT]
...
class IInteractionTrackerInertiaMotion(_inspectable.IInspectable):
    ...
    put_Condition: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                             _type.HRESULT]
    get_Motion: _Callable[[_Pointer[_Windows_UI_Composition.IExpressionAnimation]],  # value
                          _type.HRESULT]
    put_Motion: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                          _type.HRESULT]
...
class IInteractionTrackerInertiaNaturalMotion(_inspectable.IInspectable):
    ...
    put_Condition: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                             _type.HRESULT]
    get_NaturalMotion: _Callable[[_Pointer[_Windows_UI_Composition.IScalarNaturalMotionAnimation]],  # value
                                 _type.HRESULT]
    put_NaturalMotion: _Callable[[_Windows_UI_Composition.IScalarNaturalMotionAnimation],  # value
                                 _type.HRESULT]
...
class IInteractionTrackerInertiaRestingValue(_inspectable.IInspectable):
    ...
    put_Condition: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                             _type.HRESULT]
    get_RestingValue: _Callable[[_Pointer[_Windows_UI_Composition.IExpressionAnimation]],  # value
                                _type.HRESULT]
    put_RestingValue: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                                _type.HRESULT]
...
class IInteractionTrackerStatics(_inspectable.IInspectable):
    Create: _Callable[[_Windows_UI_Composition.ICompositor,  # compositor
                      ...
                      _type.HRESULT]
    CreateWithOwner: _Callable[[_Windows_UI_Composition.ICompositor,  # compositor
...
class IInteractionTrackerVector2InertiaNaturalMotion(_inspectable.IInspectable):
    ...
    put_Condition: _Callable[[_Windows_UI_Composition.IExpressionAnimation],  # value
                             _type.HRESULT]
    get_NaturalMotion: _Callable[[_Pointer[_Windows_UI_Composition.IVector2NaturalMotionAnimation]],  # value
                                 _type.HRESULT]
    put_NaturalMotion: _Callable[[_Windows_UI_Composition.IVector2NaturalMotionAnimation],  # value
                                 _type.HRESULT]
...
class IVisualInteractionSource(_inspectable.IInspectable):
    ...
    put_IsPositionYRailsEnabled: _Callable[[_type.boolean],  # value
                                           _type.HRESULT]
    get_ManipulationRedirectionMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.VisualInteractionSourceRedirectionMode]],  # value
                                               _type.HRESULT]
    put_ManipulationRedirectionMode: _Callable[[_enum.Windows.UI.Composition.Interactions.VisualInteractionSourceRedirectionMode],  # value
                                               _type.HRESULT]
    get_PositionXChainingMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionChainingMode]],  # value
                                         _type.HRESULT]
    put_PositionXChainingMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionChainingMode],  # value
                                         _type.HRESULT]
    get_PositionXSourceMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionSourceMode]],  # value
                                       _type.HRESULT]
    put_PositionXSourceMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionSourceMode],  # value
                                       _type.HRESULT]
    get_PositionYChainingMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionChainingMode]],  # value
                                         _type.HRESULT]
    put_PositionYChainingMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionChainingMode],  # value
                                         _type.HRESULT]
    get_PositionYSourceMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionSourceMode]],  # value
                                       _type.HRESULT]
    put_PositionYSourceMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionSourceMode],  # value
                                       _type.HRESULT]
    get_ScaleChainingMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionChainingMode]],  # value
                                     _type.HRESULT]
    put_ScaleChainingMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionChainingMode],  # value
                                     _type.HRESULT]
    get_ScaleSourceMode: _Callable[[_Pointer[_enum.Windows.UI.Composition.Interactions.InteractionSourceMode]],  # value
                                   _type.HRESULT]
    put_ScaleSourceMode: _Callable[[_enum.Windows.UI.Composition.Interactions.InteractionSourceMode],  # value
                                   _type.HRESULT]
    get_Source: _Callable[[_Pointer[_Windows_UI_Composition.IVisual]],  # value
                          _type.HRESULT]
    TryRedirectForManipulation: _Callable[[_Windows_UI_Input.IPointerPoint],  # pointerPoint
                                          _type.HRESULT]
