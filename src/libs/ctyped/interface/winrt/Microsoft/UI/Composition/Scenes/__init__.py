...
class ISceneComponent(_inspectable.IInspectable):
    get_ComponentType: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.Scenes.SceneComponentType]],  # value
                                 _type.HRESULT]
...
class ISceneMesh(_inspectable.IInspectable):
    get_Bounds: _Callable[[_Pointer[ISceneBoundingBox]],  # value
                          _type.HRESULT]
    get_PrimitiveTopology: _Callable[[_Pointer[_enum.Microsoft.Graphics.DirectX.DirectXPrimitiveTopology]],  # value
                                     _type.HRESULT]
    put_PrimitiveTopology: _Callable[[_enum.Microsoft.Graphics.DirectX.DirectXPrimitiveTopology],  # value
                                     _type.HRESULT]
    FillMeshAttribute: _Callable[[_enum.Microsoft.UI.Composition.Scenes.SceneAttributeSemantic,  # semantic
                                  _enum.Microsoft.Graphics.DirectX.DirectXPixelFormat,  # format
...
class ISceneNode(_inspectable.IInspectable):
    ...
    get_Transform: _Callable[[_Pointer[ISceneModelTransform]],  # value
                             _type.HRESULT]
    FindFirstComponentOfType: _Callable[[_enum.Microsoft.UI.Composition.Scenes.SceneComponentType,  # value
...
class IScenePbrMaterial(_inspectable.IInspectable):
    ...
    put_AlphaCutoff: _Callable[[_type.FLOAT],  # value
                               _type.HRESULT]
    get_AlphaMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.Scenes.SceneAlphaMode]],  # value
                             _type.HRESULT]
    put_AlphaMode: _Callable[[_enum.Microsoft.UI.Composition.Scenes.SceneAlphaMode],  # value
                             _type.HRESULT]
...
class ISceneSurfaceMaterialInput(_inspectable.IInspectable):
    ...
    put_BitmapInterpolationMode: _Callable[[_enum.Microsoft.UI.Composition.CompositionBitmapInterpolationMode],  # value
                                           _type.HRESULT]
    get_Surface: _Callable[[_Pointer[_Microsoft_UI_Composition.ICompositionSurface]],  # value
                           _type.HRESULT]
    put_Surface: _Callable[[_Microsoft_UI_Composition.ICompositionSurface],  # value
                           _type.HRESULT]
    get_WrappingUMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.Scenes.SceneWrappingMode]],  # value
                                 _type.HRESULT]
    put_WrappingUMode: _Callable[[_enum.Microsoft.UI.Composition.Scenes.SceneWrappingMode],  # value
                                 _type.HRESULT]
    get_WrappingVMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.Scenes.SceneWrappingMode]],  # value
                                 _type.HRESULT]
    put_WrappingVMode: _Callable[[_enum.Microsoft.UI.Composition.Scenes.SceneWrappingMode],  # value
                                 _type.HRESULT]
