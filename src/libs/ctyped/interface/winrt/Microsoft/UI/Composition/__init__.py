...
from ....Windows import Graphics as _Windows_Graphics
from ....Windows.Foundation import Collections as _Windows_Foundation_Collections
from ....Windows.Graphics import Effects as _Windows_Graphics_Effects
...
class IAnimationController(_inspectable.IInspectable):
    ...
    put_Progress: _Callable[[_type.FLOAT],  # value
                            _type.HRESULT]
    get_ProgressBehavior: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.AnimationControllerProgressBehavior]],  # value
                                    _type.HRESULT]
    put_ProgressBehavior: _Callable[[_enum.Microsoft.UI.Composition.AnimationControllerProgressBehavior],  # value
                                    _type.HRESULT]
    Pause: _Callable[[],
                     _type.HRESULT]
    Resume: _Callable[[],
...
class IAnimationPropertyInfo(_inspectable.IInspectable):
    get_AccessMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.AnimationPropertyAccessMode]],  # value
                              _type.HRESULT]
    put_AccessMode: _Callable[[_enum.Microsoft.UI.Composition.AnimationPropertyAccessMode],  # value
                              _type.HRESULT]
...
class IBackEasingFunction(_inspectable.IInspectable):
    get_Mode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionEasingFunctionMode]],  # value
                        _type.HRESULT]
...
class IColorKeyFrameAnimation(_inspectable.IInspectable):
    get_InterpolationColorSpace: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionColorSpace]],  # value
                                           _type.HRESULT]
    put_InterpolationColorSpace: _Callable[[_enum.Microsoft.UI.Composition.CompositionColorSpace],  # value
                                           _type.HRESULT]
    InsertKeyFrame: _Callable[[_type.FLOAT,  # normalizedProgressKey
...
class ICompositionApiInformationStatics(_inspectable.IInspectable, factory=True):
    get_ApiVersion: _Callable[[_Pointer[_type.UINT64]],  # value
                              _type.HRESULT]
...
class ICompositionDrawingSurface(_inspectable.IInspectable):
    get_AlphaMode: _Callable[[_Pointer[_enum.Microsoft.Graphics.DirectX.DirectXAlphaMode]],  # value
                             _type.HRESULT]
    get_PixelFormat: _Callable[[_Pointer[_enum.Microsoft.Graphics.DirectX.DirectXPixelFormat]],  # value
                               _type.HRESULT]
...
class ICompositionEasingFunctionStatics(_inspectable.IInspectable, factory=True):
    ...
    CreateBackEasingFunction: _Callable[[ICompositor,  # owner
                                         _enum.Microsoft.UI.Composition.CompositionEasingFunctionMode,  # mode
...
class ICompositionEffectFactory(_inspectable.IInspectable):
    ...
    get_ExtendedError: _Callable[[_Pointer[_type.HRESULT]],  # value
                                 _type.HRESULT]
    get_LoadStatus: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionEffectFactoryLoadStatus]],  # value
                              _type.HRESULT]
...
class ICompositionGradientBrush(_inspectable.IInspectable):
    ...
    get_ColorStops: _Callable[[_Pointer[ICompositionColorGradientStopCollection]],  # value
                              _type.HRESULT]
    get_ExtendMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionGradientExtendMode]],  # value
                              _type.HRESULT]
    put_ExtendMode: _Callable[[_enum.Microsoft.UI.Composition.CompositionGradientExtendMode],  # value
                              _type.HRESULT]
...
class ICompositionGradientBrush2(_inspectable.IInspectable):
    get_MappingMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionMappingMode]],  # value
                               _type.HRESULT]
    put_MappingMode: _Callable[[_enum.Microsoft.UI.Composition.CompositionMappingMode],  # value
                               _type.HRESULT]
...
class ICompositionGraphicsDevice(_inspectable.IInspectable):
    CreateDrawingSurface: _Callable[[_struct.Windows.Foundation.Size,  # sizePixels
                                     _enum.Microsoft.Graphics.DirectX.DirectXPixelFormat,  # pixelFormat
                                     _enum.Microsoft.Graphics.DirectX.DirectXAlphaMode,  # alphaMode
...
class ICompositionPropertySet(_inspectable.IInspectable):
    ...
    TryGetColor: _Callable[[_type.HSTRING,  # propertyName
                            ...
                            _Pointer[_enum.Microsoft.UI.Composition.CompositionGetValueStatus]],  # result
                           _type.HRESULT]
...
class ICompositionSpriteShape(_inspectable.IInspectable):
    ...
    get_StrokeDashArray: _Callable[[_Pointer[_Windows_Foundation_Collections.IVector[_type.FLOAT]]],  # value
                                   _type.HRESULT]
    get_StrokeDashCap: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionStrokeCap]],  # value
                                 _type.HRESULT]
    put_StrokeDashCap: _Callable[[_enum.Microsoft.UI.Composition.CompositionStrokeCap],  # value
                                 _type.HRESULT]
    get_StrokeDashOffset: _Callable[[_Pointer[_type.FLOAT]],  # value
                                    _type.HRESULT]
    put_StrokeDashOffset: _Callable[[_type.FLOAT],  # value
                                    _type.HRESULT]
    get_StrokeEndCap: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionStrokeCap]],  # value
                                _type.HRESULT]
    put_StrokeEndCap: _Callable[[_enum.Microsoft.UI.Composition.CompositionStrokeCap],  # value
                                _type.HRESULT]
    get_StrokeLineJoin: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionStrokeLineJoin]],  # value
                                  _type.HRESULT]
    put_StrokeLineJoin: _Callable[[_enum.Microsoft.UI.Composition.CompositionStrokeLineJoin],  # value
                                  _type.HRESULT]
    get_StrokeMiterLimit: _Callable[[_Pointer[_type.FLOAT]],  # value
                                    _type.HRESULT]
    put_StrokeMiterLimit: _Callable[[_type.FLOAT],  # value
                                    _type.HRESULT]
    get_StrokeStartCap: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionStrokeCap]],  # value
                                  _type.HRESULT]
    put_StrokeStartCap: _Callable[[_enum.Microsoft.UI.Composition.CompositionStrokeCap],  # value
                                  _type.HRESULT]
...
class ICompositionSupportsSystemBackdrop(_inspectable.IInspectable):
    get_SystemBackdrop: _Callable[[_Pointer[_Windows_UI_Composition.ICompositionBrush]],  # value
                                  _type.HRESULT]
    put_SystemBackdrop: _Callable[[_Windows_UI_Composition.ICompositionBrush],  # value
                                  _type.HRESULT]
...
class ICompositionSurfaceBrush(_inspectable.IInspectable):
    get_BitmapInterpolationMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionBitmapInterpolationMode]],  # value
                                           _type.HRESULT]
    put_BitmapInterpolationMode: _Callable[[_enum.Microsoft.UI.Composition.CompositionBitmapInterpolationMode],  # value
                                           _type.HRESULT]
    ...
    put_HorizontalAlignmentRatio: _Callable[[_type.FLOAT],  # value
                                            _type.HRESULT]
    get_Stretch: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionStretch]],  # value
                           _type.HRESULT]
    put_Stretch: _Callable[[_enum.Microsoft.UI.Composition.CompositionStretch],  # value
                           _type.HRESULT]
...
class ICompositor(_inspectable.IInspectable):
    ...
    CreateScalarKeyFrameAnimation: _Callable[[_Pointer[IScalarKeyFrameAnimation]],  # result
                                             _type.HRESULT]
    CreateScopedBatch: _Callable[[_enum.Microsoft.UI.Composition.CompositionBatchTypes,  # batchType
    ...
    CreateVector4KeyFrameAnimation: _Callable[[_Pointer[IVector4KeyFrameAnimation]],  # result
                                              _type.HRESULT]
    GetCommitBatch: _Callable[[_enum.Microsoft.UI.Composition.CompositionBatchTypes,  # batchType
...
class IDropShadow2(_inspectable.IInspectable):
    get_SourcePolicy: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionDropShadowSourcePolicy]],  # value
                                _type.HRESULT]
    put_SourcePolicy: _Callable[[_enum.Microsoft.UI.Composition.CompositionDropShadowSourcePolicy],  # value
                                _type.HRESULT]
...
class IKeyFrameAnimation(_inspectable.IInspectable):
    ...
    put_Duration: _Callable[[_struct.Windows.Foundation.TimeSpan],  # value
                            _type.HRESULT]
    get_IterationBehavior: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.AnimationIterationBehavior]],  # value
                                     _type.HRESULT]
    put_IterationBehavior: _Callable[[_enum.Microsoft.UI.Composition.AnimationIterationBehavior],  # value
                                     _type.HRESULT]
    ...
    get_KeyFrameCount: _Callable[[_Pointer[_type.INT32]],  # value
                                 _type.HRESULT]
    get_StopBehavior: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.AnimationStopBehavior]],  # value
                                _type.HRESULT]
    put_StopBehavior: _Callable[[_enum.Microsoft.UI.Composition.AnimationStopBehavior],  # value
                                _type.HRESULT]
...
class IKeyFrameAnimation2(_inspectable.IInspectable):
    get_Direction: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.AnimationDirection]],  # value
                             _type.HRESULT]
    put_Direction: _Callable[[_enum.Microsoft.UI.Composition.AnimationDirection],  # value
                             _type.HRESULT]


class IKeyFrameAnimation3(_inspectable.IInspectable):
    get_DelayBehavior: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.AnimationDelayBehavior]],  # value
                                 _type.HRESULT]
    put_DelayBehavior: _Callable[[_enum.Microsoft.UI.Composition.AnimationDelayBehavior],  # value
                                 _type.HRESULT]
...
class IVisual(_inspectable.IInspectable):
    ...
    put_AnchorPoint: _Callable[[_struct.Windows.Foundation.Numerics.Vector2],  # value
                               _type.HRESULT]
    get_BackfaceVisibility: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionBackfaceVisibility]],  # value
                                      _type.HRESULT]
    put_BackfaceVisibility: _Callable[[_enum.Microsoft.UI.Composition.CompositionBackfaceVisibility],  # value
                                      _type.HRESULT]
    get_BorderMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionBorderMode]],  # value
                              _type.HRESULT]
    put_BorderMode: _Callable[[_enum.Microsoft.UI.Composition.CompositionBorderMode],  # value
                              _type.HRESULT]
    ...
    put_Clip: _Callable[[ICompositionClip],  # value
                        _type.HRESULT]
    get_CompositeMode: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.CompositionCompositeMode]],  # value
                                 _type.HRESULT]
    put_CompositeMode: _Callable[[_enum.Microsoft.UI.Composition.CompositionCompositeMode],  # value
                                 _type.HRESULT]
