...
class ISceneLightingEffect2(_inspectable.IInspectable):
    get_ReflectanceModel: _Callable[[_Pointer[_enum.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel]],  # value
                                    _type.HRESULT]
    put_ReflectanceModel: _Callable[[_enum.Microsoft.UI.Composition.Effects.SceneLightingEffectReflectanceModel],  # value
                                    _type.HRESULT]
