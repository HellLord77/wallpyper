...
class ICompositeTransform3DStatics(_inspectable.IInspectable, factory=True):
    ...
    get_CenterYProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                   _type.HRESULT]
    get_CenterZProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                   _type.HRESULT]
    ...
    get_ScaleYProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                  _type.HRESULT]
    get_ScaleZProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                  _type.HRESULT]
    ...
    get_TranslateYProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                      _type.HRESULT]
    get_TranslateZProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                      _type.HRESULT]
...
class IMatrix3DHelperStatics(_inspectable.IInspectable, factory=True):
    get_Identity: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D]],  # value
                            _type.HRESULT]
    Multiply: _Callable[[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D,  # matrix1
                         _struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D,  # matrix2
                         _Pointer[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D]],  # result
                        _type.HRESULT]
    FromElements: _Callable[[_type.DOUBLE,  # m11
                             ...
                             _Pointer[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D]],  # result
                            _type.HRESULT]
    GetHasInverse: _Callable[[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D,  # target
                              _Pointer[_type.boolean]],  # result
                             _type.HRESULT]
    GetIsIdentity: _Callable[[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D,  # target
                              _Pointer[_type.boolean]],  # result
                             _type.HRESULT]
    Invert: _Callable[[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D,  # target
                       _Pointer[_struct.Microsoft.UI.Xaml.Media.Media3D.Matrix3D]],  # result
                      _type.HRESULT]
...
class IPerspectiveTransform3DStatics(_inspectable.IInspectable, factory=True):
    get_DepthProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                 _type.HRESULT]
    get_OffsetXProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                   _type.HRESULT]
    get_OffsetYProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                   _type.HRESULT]
