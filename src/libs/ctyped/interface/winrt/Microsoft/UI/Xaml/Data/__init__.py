...
class IBinding(_inspectable.IInspectable):
    get_Path: _Callable[[_Pointer[_Microsoft_UI_Xaml.IPropertyPath]],  # value
                        _type.HRESULT]
    put_Path: _Callable[[_Microsoft_UI_Xaml.IPropertyPath],  # value
                        _type.HRESULT]
    get_Mode: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Data.BindingMode]],  # value
                        _type.HRESULT]
    put_Mode: _Callable[[_enum.Microsoft.UI.Xaml.Data.BindingMode],  # value
                        _type.HRESULT]
    ...
    put_TargetNullValue: _Callable[[_inspectable.IInspectable],  # value
                                   _type.HRESULT]
    get_UpdateSourceTrigger: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Data.UpdateSourceTrigger]],  # value
                                       _type.HRESULT]
    put_UpdateSourceTrigger: _Callable[[_enum.Microsoft.UI.Xaml.Data.UpdateSourceTrigger],  # value
                                       _type.HRESULT]
...
class IBindingOperationsStatics(_inspectable.IInspectable, factory=True):
    SetBinding: _Callable[[_Microsoft_UI_Xaml.IDependencyObject,  # target
                           _Microsoft_UI_Xaml.IDependencyProperty,  # dp
...
class ICollectionView(_inspectable.IInspectable):
    ...
    LoadMoreItemsAsync: _Callable[[_type.UINT32,  # count
                                   _Pointer[_Windows_Foundation.IAsyncOperation[_struct.Microsoft.UI.Xaml.Data.LoadMoreItemsResult]]],  # operation
                                  _type.HRESULT]
...
class ICollectionViewSource(_inspectable.IInspectable):
    ...
    put_IsSourceGrouped: _Callable[[_type.boolean],  # value
                                   _type.HRESULT]
    get_ItemsPath: _Callable[[_Pointer[_Microsoft_UI_Xaml.IPropertyPath]],  # value
                             _type.HRESULT]
    put_ItemsPath: _Callable[[_Microsoft_UI_Xaml.IPropertyPath],  # value
                             _type.HRESULT]
...
class ICollectionViewSourceStatics(_inspectable.IInspectable, factory=True):
    get_SourceProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                  _type.HRESULT]
    get_ViewProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                _type.HRESULT]
    get_IsSourceGroupedProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                           _type.HRESULT]
    get_ItemsPathProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                     _type.HRESULT]
...
class IDataErrorsChangedEventArgs(_inspectable.IInspectable):
    get_PropertyName: _Callable[[_Pointer[_type.HSTRING]],  # value
                                _type.HRESULT]
    put_PropertyName: _Callable[[_type.HSTRING],  # value
                                _type.HRESULT]


class IDataErrorsChangedEventArgsFactory(_inspectable.IInspectable, factory=True):
    CreateInstance: _Callable[[_type.HSTRING,  # name
                               _Pointer[IDataErrorsChangedEventArgs]],  # value
                              _type.HRESULT]
...
class INotifyDataErrorInfo(_inspectable.IInspectable):
    get_HasErrors: _Callable[[_Pointer[_type.boolean]],  # value
                             _type.HRESULT]
    add_ErrorsChanged: _Callable[[_Windows_Foundation.IEventHandler[IDataErrorsChangedEventArgs],  # handler
                                  _Pointer[_struct.EventRegistrationToken]],  # token
                                 _type.HRESULT]
    remove_ErrorsChanged: _Callable[[_struct.EventRegistrationToken],  # token
                                    _type.HRESULT]
    GetErrors: _Callable[[_type.HSTRING,  # propertyName
                          _Pointer[_Windows_Foundation_Collections.IIterable[_inspectable.IInspectable]]],  # result
                         _type.HRESULT]
...
class IRelativeSource(_inspectable.IInspectable):
    get_Mode: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Data.RelativeSourceMode]],  # value
                        _type.HRESULT]
    put_Mode: _Callable[[_enum.Microsoft.UI.Xaml.Data.RelativeSourceMode],  # value
                        _type.HRESULT]
