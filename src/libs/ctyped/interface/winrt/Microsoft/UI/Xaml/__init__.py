...
from .Automation import Peers as _Microsoft_UI_Xaml_Automation_Peers
...
from .Media import Imaging as _Microsoft_UI_Xaml_Media_Imaging
from .Media import Media3D as _Microsoft_UI_Xaml_Media_Media3D
...
from .. import Windowing as _Microsoft_UI_Windowing
from ...Windows.ApplicationModel import Resources as _Microsoft_Windows_ApplicationModel_Resources
from .... import inspectable as _inspectable
from ....Windows import ApplicationModel as _Windows_ApplicationModel
from ....Windows import Foundation as _Windows_Foundation
from ....Windows.ApplicationModel import Activation as _Windows_ApplicationModel_Activation
...
class IApplication(_inspectable.IInspectable):
    ...
    get_DebugSettings: _Callable[[_Pointer[IDebugSettings]],  # value
                                 _type.HRESULT]
    get_RequestedTheme: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ApplicationTheme]],  # value
                                  _type.HRESULT]
    put_RequestedTheme: _Callable[[_enum.Microsoft.UI.Xaml.ApplicationTheme],  # value
                                  _type.HRESULT]
    get_FocusVisualKind: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.FocusVisualKind]],  # value
                                   _type.HRESULT]
    put_FocusVisualKind: _Callable[[_enum.Microsoft.UI.Xaml.FocusVisualKind],  # value
                                   _type.HRESULT]
    get_HighContrastAdjustment: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ApplicationHighContrastAdjustment]],  # value
                                          _type.HRESULT]
    put_HighContrastAdjustment: _Callable[[_enum.Microsoft.UI.Xaml.ApplicationHighContrastAdjustment],  # value
                                          _type.HRESULT]
...
class IApplication2(_inspectable.IInspectable):
    add_ResourceManagerRequested: _Callable[[_Windows_Foundation.ITypedEventHandler[_inspectable.IInspectable, IResourceManagerRequestedEventArgs],  # handler
                                             _Pointer[_struct.EventRegistrationToken]],  # token
                                            _type.HRESULT]
    remove_ResourceManagerRequested: _Callable[[_struct.EventRegistrationToken],  # token
                                               _type.HRESULT]
...
class IApplicationOverrides(_inspectable.IInspectable):
    OnLaunched: _Callable[[ILaunchActivatedEventArgs],  # args
                          _type.HRESULT]
...
class IApplicationStatics(_inspectable.IInspectable, factory=True):
    ...
    LoadComponentWithResourceLocation: _Callable[[_inspectable.IInspectable,  # component
                                                  _Windows_Foundation.IUriRuntimeClass,  # resourceLocator
                                                  _enum.Microsoft.UI.Xaml.Controls.Primitives.ComponentResourceLocation],  # componentResourceLocation
                                                 _type.HRESULT]
...
class ICornerRadiusHelperStatics(_inspectable.IInspectable, factory=True):
    FromRadii: _Callable[[_type.DOUBLE,  # topLeft
                          ...
                          _Pointer[_struct.Microsoft.UI.Xaml.CornerRadius]],  # result
                         _type.HRESULT]
...
class IDataTemplateExtension(_inspectable.IInspectable):
    ...
    ProcessBinding: _Callable[[_type.UINT32,  # phase
                              ...
                              _type.HRESULT]
    ProcessBindings: _Callable[[_Microsoft_UI_Xaml_Controls.IContainerContentChangingEventArgs,  # arg
...
class IDataTemplateStatics(_inspectable.IInspectable, factory=True):
...
class IDebugSettings2(_inspectable.IInspectable):
    get_IsXamlResourceReferenceTracingEnabled: _Callable[[_Pointer[_type.boolean]],  # value
                                                         _type.HRESULT]
    put_IsXamlResourceReferenceTracingEnabled: _Callable[[_type.boolean],  # value
                                                         _type.HRESULT]
    add_XamlResourceReferenceFailed: _Callable[[_Windows_Foundation.ITypedEventHandler[IDebugSettings, IXamlResourceReferenceFailedEventArgs],  # handler
                                                _Pointer[_struct.EventRegistrationToken]],  # token
                                               _type.HRESULT]
    remove_XamlResourceReferenceFailed: _Callable[[_struct.EventRegistrationToken],  # token
                                                  _type.HRESULT]
...
class IDragUI(_inspectable.IInspectable):
    SetContentFromBitmapImage: _Callable[[_Microsoft_UI_Xaml_Media_Imaging.IBitmapImage],  # bitmapImage
                                         _type.HRESULT]
    SetContentFromBitmapImageWithAnchorPoint: _Callable[[_Microsoft_UI_Xaml_Media_Imaging.IBitmapImage,  # bitmapImage
...
class IDurationHelperStatics(_inspectable.IInspectable, factory=True):
    get_Automatic: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Duration]],  # value
                             _type.HRESULT]
    get_Forever: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Duration]],  # value
                           _type.HRESULT]
    Compare: _Callable[[_struct.Microsoft.UI.Xaml.Duration,  # duration1
                        _struct.Microsoft.UI.Xaml.Duration,  # duration2
                        _Pointer[_type.INT32]],  # result
                       _type.HRESULT]
    FromTimeSpan: _Callable[[_struct.Windows.Foundation.TimeSpan,  # timeSpan
                             _Pointer[_struct.Microsoft.UI.Xaml.Duration]],  # result
                            _type.HRESULT]
    GetHasTimeSpan: _Callable[[_struct.Microsoft.UI.Xaml.Duration,  # target
                               _Pointer[_type.boolean]],  # result
                              _type.HRESULT]
    Add: _Callable[[_struct.Microsoft.UI.Xaml.Duration,  # target
                    _struct.Microsoft.UI.Xaml.Duration,  # duration
                    _Pointer[_struct.Microsoft.UI.Xaml.Duration]],  # result
                   _type.HRESULT]
    Equals: _Callable[[_struct.Microsoft.UI.Xaml.Duration,  # target
                       _struct.Microsoft.UI.Xaml.Duration,  # value
                       _Pointer[_type.boolean]],  # result
                      _type.HRESULT]
    Subtract: _Callable[[_struct.Microsoft.UI.Xaml.Duration,  # target
                         _struct.Microsoft.UI.Xaml.Duration,  # duration
                         _Pointer[_struct.Microsoft.UI.Xaml.Duration]],  # result
                        _type.HRESULT]
...
class IElementSoundPlayerStatics(_inspectable.IInspectable, factory=True):
    ...
    put_Volume: _Callable[[_type.DOUBLE],  # value
                          _type.HRESULT]
    get_State: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ElementSoundPlayerState]],  # value
                         _type.HRESULT]
    put_State: _Callable[[_enum.Microsoft.UI.Xaml.ElementSoundPlayerState],  # value
                         _type.HRESULT]
    get_SpatialAudioMode: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ElementSpatialAudioMode]],  # value
                                    _type.HRESULT]
    put_SpatialAudioMode: _Callable[[_enum.Microsoft.UI.Xaml.ElementSpatialAudioMode],  # value
                                    _type.HRESULT]
    Play: _Callable[[_enum.Microsoft.UI.Xaml.ElementSoundKind],  # sound
                    _type.HRESULT]
...
class IFrameworkElement(_inspectable.IInspectable):
    ...
    put_MaxHeight: _Callable[[_type.DOUBLE],  # value
                             _type.HRESULT]
    get_HorizontalAlignment: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.HorizontalAlignment]],  # value
                                       _type.HRESULT]
    put_HorizontalAlignment: _Callable[[_enum.Microsoft.UI.Xaml.HorizontalAlignment],  # value
                                       _type.HRESULT]
    get_VerticalAlignment: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.VerticalAlignment]],  # value
                                     _type.HRESULT]
    put_VerticalAlignment: _Callable[[_enum.Microsoft.UI.Xaml.VerticalAlignment],  # value
                                     _type.HRESULT]
    ...
    put_AllowFocusOnInteraction: _Callable[[_type.boolean],  # value
                                           _type.HRESULT]
    get_FocusVisualMargin: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Thickness]],  # value
                                     _type.HRESULT]
    put_FocusVisualMargin: _Callable[[_struct.Microsoft.UI.Xaml.Thickness],  # value
                                     _type.HRESULT]
    get_FocusVisualSecondaryThickness: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Thickness]],  # value
                                                 _type.HRESULT]
    put_FocusVisualSecondaryThickness: _Callable[[_struct.Microsoft.UI.Xaml.Thickness],  # value
                                                 _type.HRESULT]
    get_FocusVisualPrimaryThickness: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Thickness]],  # value
                                               _type.HRESULT]
    put_FocusVisualPrimaryThickness: _Callable[[_struct.Microsoft.UI.Xaml.Thickness],  # value
                                               _type.HRESULT]
    get_FocusVisualSecondaryBrush: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.IBrush]],  # value
                                             _type.HRESULT]
    put_FocusVisualSecondaryBrush: _Callable[[_Microsoft_UI_Xaml_Media.IBrush],  # value
                                             _type.HRESULT]
    get_FocusVisualPrimaryBrush: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.IBrush]],  # value
                                           _type.HRESULT]
    put_FocusVisualPrimaryBrush: _Callable[[_Microsoft_UI_Xaml_Media.IBrush],  # value
                                           _type.HRESULT]
    ...
    put_FlowDirection: _Callable[[_enum.Microsoft.UI.Xaml.FlowDirection],  # value
                                 _type.HRESULT]
    get_RequestedTheme: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ElementTheme]],  # value
                                  _type.HRESULT]
    put_RequestedTheme: _Callable[[_enum.Microsoft.UI.Xaml.ElementTheme],  # value
                                  _type.HRESULT]
    get_IsLoaded: _Callable[[_Pointer[_type.boolean]],  # value
                            _type.HRESULT]
    get_ActualTheme: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ElementTheme]],  # value
                               _type.HRESULT]
    ...
    SetBinding: _Callable[[IDependencyProperty,  # dp
                           _Microsoft_UI_Xaml_Data.IBindingBase],  # binding
                          _type.HRESULT]
    GetBindingExpression: _Callable[[IDependencyProperty,  # dp
                                     _Pointer[_Microsoft_UI_Xaml_Data.IBindingExpression]],  # result
                                    _type.HRESULT]
...
class IFrameworkElementProtected(_inspectable.IInspectable):
...
class IGridLengthHelperStatics(_inspectable.IInspectable, factory=True):
    get_Auto: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.GridLength]],  # value
                        _type.HRESULT]
    FromPixels: _Callable[[_type.DOUBLE,  # pixels
                           _Pointer[_struct.Microsoft.UI.Xaml.GridLength]],  # result
                          _type.HRESULT]
    FromValueAndType: _Callable[[_type.DOUBLE,  # value
                                 _enum.Microsoft.UI.Xaml.GridUnitType,  # type
                                 _Pointer[_struct.Microsoft.UI.Xaml.GridLength]],  # result
                                _type.HRESULT]
    GetIsAbsolute: _Callable[[_struct.Microsoft.UI.Xaml.GridLength,  # target
                              _Pointer[_type.boolean]],  # result
                             _type.HRESULT]
    GetIsAuto: _Callable[[_struct.Microsoft.UI.Xaml.GridLength,  # target
                          _Pointer[_type.boolean]],  # result
                         _type.HRESULT]
    GetIsStar: _Callable[[_struct.Microsoft.UI.Xaml.GridLength,  # target
                          _Pointer[_type.boolean]],  # result
                         _type.HRESULT]
    Equals: _Callable[[_struct.Microsoft.UI.Xaml.GridLength,  # target
                       _struct.Microsoft.UI.Xaml.GridLength,  # value
                       _Pointer[_type.boolean]],  # result
                      _type.HRESULT]
...
class ILaunchActivatedEventArgs(_inspectable.IInspectable):
    get_Arguments: _Callable[[_Pointer[_type.HSTRING]],  # value
                             _type.HRESULT]
    get_UWPLaunchActivatedEventArgs: _Callable[[_Pointer[_Windows_ApplicationModel_Activation.ILaunchActivatedEventArgs]],  # value
                                               _type.HRESULT]
...
class IResourceManagerRequestedEventArgs(_inspectable.IInspectable):
    get_CustomResourceManager: _Callable[[_Pointer[_Microsoft_Windows_ApplicationModel_Resources.IResourceManager]],  # value
                                         _type.HRESULT]
    put_CustomResourceManager: _Callable[[_Microsoft_Windows_ApplicationModel_Resources.IResourceManager],  # value
                                         _type.HRESULT]
...
class IUIElement(_inspectable.IInspectable):
    ...
    put_Opacity: _Callable[[_type.DOUBLE],  # value
                           _type.HRESULT]
    get_Clip: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.IRectangleGeometry]],  # value
                        _type.HRESULT]
    put_Clip: _Callable[[_Microsoft_UI_Xaml_Media.IRectangleGeometry],  # value
                        _type.HRESULT]
    get_RenderTransform: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.ITransform]],  # value
                                   _type.HRESULT]
    put_RenderTransform: _Callable[[_Microsoft_UI_Xaml_Media.ITransform],  # value
                                   _type.HRESULT]
    get_Projection: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.IProjection]],  # value
                              _type.HRESULT]
    put_Projection: _Callable[[_Microsoft_UI_Xaml_Media.IProjection],  # value
                              _type.HRESULT]
    get_Transform3D: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media_Media3D.ITransform3D]],  # value
                               _type.HRESULT]
    put_Transform3D: _Callable[[_Microsoft_UI_Xaml_Media_Media3D.ITransform3D],  # value
                               _type.HRESULT]
    ...
    put_IsHitTestVisible: _Callable[[_type.boolean],  # value
                                    _type.HRESULT]
    get_Visibility: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Visibility]],  # value
                              _type.HRESULT]
    put_Visibility: _Callable[[_enum.Microsoft.UI.Xaml.Visibility],  # value
                              _type.HRESULT]
    ...
    put_UseLayoutRounding: _Callable[[_type.boolean],  # value
                                     _type.HRESULT]
    get_Transitions: _Callable[[_Pointer[_Windows_Foundation_Collections.IVector[_Microsoft_UI_Xaml_Media_Animation.ITransition]]],  # value
                               _type.HRESULT]
    put_Transitions: _Callable[[_Windows_Foundation_Collections.IVector[_Microsoft_UI_Xaml_Media_Animation.ITransition]],  # value
                               _type.HRESULT]
    get_CacheMode: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.ICacheMode]],  # value
                             _type.HRESULT]
    put_CacheMode: _Callable[[_Microsoft_UI_Xaml_Media.ICacheMode],  # value
                             _type.HRESULT]
    ...
    put_IsHoldingEnabled: _Callable[[_type.boolean],  # value
                                    _type.HRESULT]
    get_ManipulationMode: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Input.ManipulationModes]],  # value
                                    _type.HRESULT]
    put_ManipulationMode: _Callable[[_enum.Microsoft.UI.Xaml.Input.ManipulationModes],  # value
                                    _type.HRESULT]
    get_PointerCaptures: _Callable[[_Pointer[_Windows_Foundation_Collections.IVectorView[_Microsoft_UI_Xaml_Input.IPointer]]],  # value
                                   _type.HRESULT]
    get_ContextFlyout: _Callable[[_Pointer[_Microsoft_UI_Xaml_Controls_Primitives.IFlyoutBase]],  # value
                                 _type.HRESULT]
    put_ContextFlyout: _Callable[[_Microsoft_UI_Xaml_Controls_Primitives.IFlyoutBase],  # value
                                 _type.HRESULT]
    get_CompositeMode: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Media.ElementCompositeMode]],  # value
                                 _type.HRESULT]
    put_CompositeMode: _Callable[[_enum.Microsoft.UI.Xaml.Media.ElementCompositeMode],  # value
                                 _type.HRESULT]
    get_Lights: _Callable[[_Pointer[_Windows_Foundation_Collections.IVector[_Microsoft_UI_Xaml_Media.IXamlLight]]],  # value
                          _type.HRESULT]
    ...
    put_KeyTipTarget: _Callable[[IDependencyObject],  # value
                                _type.HRESULT]
    get_XYFocusKeyboardNavigation: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Input.XYFocusKeyboardNavigationMode]],  # value
                                             _type.HRESULT]
    put_XYFocusKeyboardNavigation: _Callable[[_enum.Microsoft.UI.Xaml.Input.XYFocusKeyboardNavigationMode],  # value
                                             _type.HRESULT]
    ...
    put_XYFocusRightNavigationStrategy: _Callable[[_enum.Microsoft.UI.Xaml.Input.XYFocusNavigationStrategy],  # value
                                                  _type.HRESULT]
    get_KeyboardAccelerators: _Callable[[_Pointer[_Windows_Foundation_Collections.IVector[_Microsoft_UI_Xaml_Input.IKeyboardAccelerator]]],  # value
                                        _type.HRESULT]
    ...
    put_KeyboardAcceleratorPlacementTarget: _Callable[[IDependencyObject],  # value
                                                      _type.HRESULT]
    get_KeyboardAcceleratorPlacementMode: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Input.KeyboardAcceleratorPlacementMode]],  # value
                                                    _type.HRESULT]
    put_KeyboardAcceleratorPlacementMode: _Callable[[_enum.Microsoft.UI.Xaml.Input.KeyboardAcceleratorPlacementMode],  # value
                                                    _type.HRESULT]
    get_HighContrastAdjustment: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.ElementHighContrastAdjustment]],  # value
                                          _type.HRESULT]
    put_HighContrastAdjustment: _Callable[[_enum.Microsoft.UI.Xaml.ElementHighContrastAdjustment],  # value
                                          _type.HRESULT]
    get_TabFocusNavigation: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Input.KeyboardNavigationMode]],  # value
                                      _type.HRESULT]
    put_TabFocusNavigation: _Callable[[_enum.Microsoft.UI.Xaml.Input.KeyboardNavigationMode],  # value
                                      _type.HRESULT]
    ...
    put_XamlRoot: _Callable[[IXamlRoot],  # value
                            _type.HRESULT]
    get_Shadow: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media.IShadow]],  # value
                          _type.HRESULT]
    put_Shadow: _Callable[[_Microsoft_UI_Xaml_Media.IShadow],  # value
                          _type.HRESULT]
    ...
    put_UseSystemFocusVisuals: _Callable[[_type.boolean],  # value
                                         _type.HRESULT]
    get_XYFocusLeft: _Callable[[_Pointer[IDependencyObject]],  # value
                               _type.HRESULT]
    put_XYFocusLeft: _Callable[[IDependencyObject],  # value
                               _type.HRESULT]
    get_XYFocusRight: _Callable[[_Pointer[IDependencyObject]],  # value
                                _type.HRESULT]
    put_XYFocusRight: _Callable[[IDependencyObject],  # value
                                _type.HRESULT]
    get_XYFocusUp: _Callable[[_Pointer[IDependencyObject]],  # value
                             _type.HRESULT]
    put_XYFocusUp: _Callable[[IDependencyObject],  # value
                             _type.HRESULT]
    get_XYFocusDown: _Callable[[_Pointer[IDependencyObject]],  # value
                               _type.HRESULT]
    put_XYFocusDown: _Callable[[IDependencyObject],  # value
                               _type.HRESULT]
    ...
    put_TabIndex: _Callable[[_type.INT32],  # value
                            _type.HRESULT]
    add_KeyUp: _Callable[[_Microsoft_UI_Xaml_Input.IKeyEventHandler,  # handler
                          _Pointer[_struct.EventRegistrationToken]],  # token
                         _type.HRESULT]
    remove_KeyUp: _Callable[[_struct.EventRegistrationToken],  # token
                            _type.HRESULT]
    add_KeyDown: _Callable[[_Microsoft_UI_Xaml_Input.IKeyEventHandler,  # handler
                            _Pointer[_struct.EventRegistrationToken]],  # token
                           _type.HRESULT]
    ...
    remove_DropCompleted: _Callable[[_struct.EventRegistrationToken],  # token
                                    _type.HRESULT]
    add_CharacterReceived: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.ICharacterReceivedRoutedEventArgs],  # handler
                                      _Pointer[_struct.EventRegistrationToken]],  # token
                                     _type.HRESULT]
    ...
    remove_Drop: _Callable[[_struct.EventRegistrationToken],  # token
                           _type.HRESULT]
    add_PointerPressed: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                   _Pointer[_struct.EventRegistrationToken]],  # token
                                  _type.HRESULT]
    remove_PointerPressed: _Callable[[_struct.EventRegistrationToken],  # token
                                     _type.HRESULT]
    add_PointerMoved: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                 _Pointer[_struct.EventRegistrationToken]],  # token
                                _type.HRESULT]
    remove_PointerMoved: _Callable[[_struct.EventRegistrationToken],  # token
                                   _type.HRESULT]
    add_PointerReleased: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                    _Pointer[_struct.EventRegistrationToken]],  # token
                                   _type.HRESULT]
    remove_PointerReleased: _Callable[[_struct.EventRegistrationToken],  # token
                                      _type.HRESULT]
    add_PointerEntered: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                   _Pointer[_struct.EventRegistrationToken]],  # token
                                  _type.HRESULT]
    remove_PointerEntered: _Callable[[_struct.EventRegistrationToken],  # token
                                     _type.HRESULT]
    add_PointerExited: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                  _Pointer[_struct.EventRegistrationToken]],  # token
                                 _type.HRESULT]
    remove_PointerExited: _Callable[[_struct.EventRegistrationToken],  # token
                                    _type.HRESULT]
    add_PointerCaptureLost: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                       _Pointer[_struct.EventRegistrationToken]],  # token
                                      _type.HRESULT]
    remove_PointerCaptureLost: _Callable[[_struct.EventRegistrationToken],  # token
                                         _type.HRESULT]
    add_PointerCanceled: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                    _Pointer[_struct.EventRegistrationToken]],  # token
                                   _type.HRESULT]
    remove_PointerCanceled: _Callable[[_struct.EventRegistrationToken],  # token
                                      _type.HRESULT]
    add_PointerWheelChanged: _Callable[[_Microsoft_UI_Xaml_Input.IPointerEventHandler,  # handler
                                        _Pointer[_struct.EventRegistrationToken]],  # token
                                       _type.HRESULT]
    remove_PointerWheelChanged: _Callable[[_struct.EventRegistrationToken],  # token
                                          _type.HRESULT]
    add_Tapped: _Callable[[_Microsoft_UI_Xaml_Input.ITappedEventHandler,  # handler
                           _Pointer[_struct.EventRegistrationToken]],  # token
                          _type.HRESULT]
    remove_Tapped: _Callable[[_struct.EventRegistrationToken],  # token
                             _type.HRESULT]
    add_DoubleTapped: _Callable[[_Microsoft_UI_Xaml_Input.IDoubleTappedEventHandler,  # handler
                                 _Pointer[_struct.EventRegistrationToken]],  # token
                                _type.HRESULT]
    remove_DoubleTapped: _Callable[[_struct.EventRegistrationToken],  # token
                                   _type.HRESULT]
    add_Holding: _Callable[[_Microsoft_UI_Xaml_Input.IHoldingEventHandler,  # handler
                            _Pointer[_struct.EventRegistrationToken]],  # token
                           _type.HRESULT]
    remove_Holding: _Callable[[_struct.EventRegistrationToken],  # token
                              _type.HRESULT]
    add_ContextRequested: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.IContextRequestedEventArgs],  # handler
                                     _Pointer[_struct.EventRegistrationToken]],  # token
                                    _type.HRESULT]
    ...
    remove_ContextCanceled: _Callable[[_struct.EventRegistrationToken],  # token
                                      _type.HRESULT]
    add_RightTapped: _Callable[[_Microsoft_UI_Xaml_Input.IRightTappedEventHandler,  # handler
                                _Pointer[_struct.EventRegistrationToken]],  # token
                               _type.HRESULT]
    remove_RightTapped: _Callable[[_struct.EventRegistrationToken],  # token
                                  _type.HRESULT]
    add_ManipulationStarting: _Callable[[_Microsoft_UI_Xaml_Input.IManipulationStartingEventHandler,  # handler
                                         _Pointer[_struct.EventRegistrationToken]],  # token
                                        _type.HRESULT]
    remove_ManipulationStarting: _Callable[[_struct.EventRegistrationToken],  # token
                                           _type.HRESULT]
    add_ManipulationInertiaStarting: _Callable[[_Microsoft_UI_Xaml_Input.IManipulationInertiaStartingEventHandler,  # handler
                                                _Pointer[_struct.EventRegistrationToken]],  # token
                                               _type.HRESULT]
    remove_ManipulationInertiaStarting: _Callable[[_struct.EventRegistrationToken],  # token
                                                  _type.HRESULT]
    add_ManipulationStarted: _Callable[[_Microsoft_UI_Xaml_Input.IManipulationStartedEventHandler,  # handler
                                        _Pointer[_struct.EventRegistrationToken]],  # token
                                       _type.HRESULT]
    remove_ManipulationStarted: _Callable[[_struct.EventRegistrationToken],  # token
                                          _type.HRESULT]
    add_ManipulationDelta: _Callable[[_Microsoft_UI_Xaml_Input.IManipulationDeltaEventHandler,  # handler
                                      _Pointer[_struct.EventRegistrationToken]],  # token
                                     _type.HRESULT]
    remove_ManipulationDelta: _Callable[[_struct.EventRegistrationToken],  # token
                                        _type.HRESULT]
    add_ManipulationCompleted: _Callable[[_Microsoft_UI_Xaml_Input.IManipulationCompletedEventHandler,  # handler
                                          _Pointer[_struct.EventRegistrationToken]],  # token
                                         _type.HRESULT]
    remove_ManipulationCompleted: _Callable[[_struct.EventRegistrationToken],  # token
                                            _type.HRESULT]
    add_AccessKeyDisplayRequested: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.IAccessKeyDisplayRequestedEventArgs],  # handler
                                              _Pointer[_struct.EventRegistrationToken]],  # token
                                             _type.HRESULT]
    remove_AccessKeyDisplayRequested: _Callable[[_struct.EventRegistrationToken],  # token
                                                _type.HRESULT]
    add_AccessKeyDisplayDismissed: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.IAccessKeyDisplayDismissedEventArgs],  # handler
                                              _Pointer[_struct.EventRegistrationToken]],  # token
                                             _type.HRESULT]
    remove_AccessKeyDisplayDismissed: _Callable[[_struct.EventRegistrationToken],  # token
                                                _type.HRESULT]
    add_AccessKeyInvoked: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.IAccessKeyInvokedEventArgs],  # handler
                                     _Pointer[_struct.EventRegistrationToken]],  # token
                                    _type.HRESULT]
    remove_AccessKeyInvoked: _Callable[[_struct.EventRegistrationToken],  # token
                                       _type.HRESULT]
    add_ProcessKeyboardAccelerators: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.IProcessKeyboardAcceleratorEventArgs],  # handler
                                                _Pointer[_struct.EventRegistrationToken]],  # token
                                               _type.HRESULT]
    remove_ProcessKeyboardAccelerators: _Callable[[_struct.EventRegistrationToken],  # token
                                                  _type.HRESULT]
    add_GettingFocus: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.IGettingFocusEventArgs],  # handler
                                 _Pointer[_struct.EventRegistrationToken]],  # token
                                _type.HRESULT]
    remove_GettingFocus: _Callable[[_struct.EventRegistrationToken],  # token
                                   _type.HRESULT]
    add_LosingFocus: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.ILosingFocusEventArgs],  # handler
                                _Pointer[_struct.EventRegistrationToken]],  # token
                               _type.HRESULT]
    remove_LosingFocus: _Callable[[_struct.EventRegistrationToken],  # token
                                  _type.HRESULT]
    add_NoFocusCandidateFound: _Callable[[_Windows_Foundation.ITypedEventHandler[IUIElement, _Microsoft_UI_Xaml_Input.INoFocusCandidateFoundEventArgs],  # handler
                                          _Pointer[_struct.EventRegistrationToken]],  # token
                                         _type.HRESULT]
    remove_NoFocusCandidateFound: _Callable[[_struct.EventRegistrationToken],  # token
                                            _type.HRESULT]
    add_PreviewKeyDown: _Callable[[_Microsoft_UI_Xaml_Input.IKeyEventHandler,  # handler
                                   _Pointer[_struct.EventRegistrationToken]],  # token
                                  _type.HRESULT]
    remove_PreviewKeyDown: _Callable[[_struct.EventRegistrationToken],  # token
                                     _type.HRESULT]
    add_PreviewKeyUp: _Callable[[_Microsoft_UI_Xaml_Input.IKeyEventHandler,  # handler
                                 _Pointer[_struct.EventRegistrationToken]],  # token
                                _type.HRESULT]
    ...
    Arrange: _Callable[[_struct.Windows.Foundation.Rect],  # finalRect
                       _type.HRESULT]
    CapturePointer: _Callable[[_Microsoft_UI_Xaml_Input.IPointer,  # value
                               _Pointer[_type.boolean]],  # result
                              _type.HRESULT]
    ReleasePointerCapture: _Callable[[_Microsoft_UI_Xaml_Input.IPointer],  # value
                                     _type.HRESULT]
    ...
    TransformToVisual: _Callable[[IUIElement,  # visual
                                  _Pointer[_Microsoft_UI_Xaml_Media.IGeneralTransform]],  # result
                                 _type.HRESULT]
    ...
    CancelDirectManipulations: _Callable[[_Pointer[_type.boolean]],  # result
                                         _type.HRESULT]
    StartDragAsync: _Callable[[_Microsoft_UI_Input.IPointerPoint,  # pointerPoint
    ...
    Focus: _Callable[[_enum.Microsoft.UI.Xaml.FocusState,  # value
                      _Pointer[_type.boolean]],  # result
                     _type.HRESULT]
    StartAnimation: _Callable[[_Microsoft_UI_Composition.ICompositionAnimationBase],  # animation
                              _type.HRESULT]
    StopAnimation: _Callable[[_Microsoft_UI_Composition.ICompositionAnimationBase],  # animation
                             _type.HRESULT]
...
class IUIElementOverrides(_inspectable.IInspectable):
    OnCreateAutomationPeer: _Callable[[_Pointer[_Microsoft_UI_Xaml_Automation_Peers.IAutomationPeer]],  # result
                                      _type.HRESULT]
    ...
    GetChildrenInTabFocusOrder: _Callable[[_Pointer[_Windows_Foundation_Collections.IIterable[IDependencyObject]]],  # result
                                          _type.HRESULT]
    OnKeyboardAcceleratorInvoked: _Callable[[_Microsoft_UI_Xaml_Input.IKeyboardAcceleratorInvokedEventArgs],  # args
                                            _type.HRESULT]
...
class IUIElementProtected(_inspectable.IInspectable):
    get_ProtectedCursor: _Callable[[_Pointer[_Microsoft_UI_Input.IInputCursor]],  # value
                                   _type.HRESULT]
    put_ProtectedCursor: _Callable[[_Microsoft_UI_Input.IInputCursor],  # value
                                   _type.HRESULT]
...
class IUIElementStatics(_inspectable.IInspectable, factory=True):
    ...
    get_ShadowProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                  _type.HRESULT]
    get_FocusStateProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                      _type.HRESULT]
    get_UseSystemFocusVisualsProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                                 _type.HRESULT]
    get_XYFocusLeftProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                       _type.HRESULT]
    get_XYFocusRightProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                        _type.HRESULT]
    get_XYFocusUpProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                     _type.HRESULT]
    get_XYFocusDownProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                       _type.HRESULT]
    get_IsTabStopProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                     _type.HRESULT]
    get_TabIndexProperty: _Callable[[_Pointer[IDependencyProperty]],  # value
                                    _type.HRESULT]
    TryStartDirectManipulation: _Callable[[_Microsoft_UI_Xaml_Input.IPointer,  # value
                                           _Pointer[_type.boolean]],  # result
                                          _type.HRESULT]
...
class IUIElementWeakCollectionFactory(_inspectable.IInspectable):
    CreateInstance: _Callable[[_inspectable.IInspectable,  # baseInterface
                               _Pointer[_inspectable.IInspectable],  # innerInterface
                               _Pointer[_Windows_Foundation_Collections.IVector[IUIElement]]],  # value
                              _type.HRESULT]
...
class IVector3Transition(_inspectable.IInspectable):
    ...
    put_Duration: _Callable[[_struct.Windows.Foundation.TimeSpan],  # value
                            _type.HRESULT]
    get_Components: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Vector3TransitionComponents]],  # value
                              _type.HRESULT]
    put_Components: _Callable[[_enum.Microsoft.UI.Xaml.Vector3TransitionComponents],  # value
                              _type.HRESULT]
...
class IVisualState(_inspectable.IInspectable):
    get_Name: _Callable[[_Pointer[_type.HSTRING]],  # value
                        _type.HRESULT]
    get_Storyboard: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media_Animation.IStoryboard]],  # value
                              _type.HRESULT]
    put_Storyboard: _Callable[[_Microsoft_UI_Xaml_Media_Animation.IStoryboard],  # value
                              _type.HRESULT]
    get_Setters: _Callable[[_Pointer[ISetterBaseCollection]],  # value
                           _type.HRESULT]
...
class IVisualStateChangedEventArgs(_inspectable.IInspectable):
    ...
    put_NewState: _Callable[[IVisualState],  # value
                            _type.HRESULT]
    get_Control: _Callable[[_Pointer[_Microsoft_UI_Xaml_Controls.IControl]],  # value
                           _type.HRESULT]
    put_Control: _Callable[[_Microsoft_UI_Xaml_Controls.IControl],  # value
                           _type.HRESULT]
...
class IVisualStateManagerOverrides(_inspectable.IInspectable):
    GoToStateCore: _Callable[[_Microsoft_UI_Xaml_Controls.IControl,  # control
...
class IVisualStateManagerProtected(_inspectable.IInspectable):
    RaiseCurrentStateChanging: _Callable[[IVisualStateGroup,  # stateGroup
                                          ...
                                          _Microsoft_UI_Xaml_Controls.IControl],  # control
                                         _type.HRESULT]
...
class IVisualStateManagerStatics(_inspectable.IInspectable, factory=True):
    ...
    SetCustomVisualStateManager: _Callable[[IFrameworkElement,  # obj
                                           ...
                                           _type.HRESULT]
    GoToState: _Callable[[_Microsoft_UI_Xaml_Controls.IControl,  # control
                          _type.HSTRING,  # stateName
                          _type.boolean,  # useTransitions
                          _Pointer[_type.boolean]],  # result
                         _type.HRESULT]
...
class IVisualTransition(_inspectable.IInspectable):
    get_GeneratedDuration: _Callable[[_Pointer[_struct.Microsoft.UI.Xaml.Duration]],  # value
                                     _type.HRESULT]
    put_GeneratedDuration: _Callable[[_struct.Microsoft.UI.Xaml.Duration],  # value
                                     _type.HRESULT]
    get_GeneratedEasingFunction: _Callable[[_Pointer[_Microsoft_UI_Xaml_Media_Animation.IEasingFunctionBase]],  # value
                                           _type.HRESULT]
    put_GeneratedEasingFunction: _Callable[[_Microsoft_UI_Xaml_Media_Animation.IEasingFunctionBase],  # value
                                           _type.HRESULT]
...
class IWindow(_inspectable.IInspectable):
    ...
    put_Content: _Callable[[IUIElement],  # value
                           _type.HRESULT]
    CoreWindow: _Callable[[_Pointer[_Windows_UI_Core.ICoreWindow]],  # value
                          _type.HRESULT]
    get_Compositor: _Callable[[_Pointer[_Microsoft_UI_Composition.ICompositor]],  # value
                              _type.HRESULT]
    Dispatcher: _Callable[[_Pointer[_Windows_UI_Core.ICoreDispatcher]],  # value
                          _type.HRESULT]
    get_DispatcherQueue: _Callable[[_Pointer[_Microsoft_UI_Dispatching.IDispatcherQueue]],  # value
                                   _type.HRESULT]
    ...
    put_ExtendsContentIntoTitleBar: _Callable[[_type.boolean],  # value
                                              _type.HRESULT]
    add_Activated: _Callable[[_Windows_Foundation.ITypedEventHandler[_inspectable.IInspectable, IWindowActivatedEventArgs],  # handler
                              _Pointer[_struct.EventRegistrationToken]],  # token
                             _type.HRESULT]
    remove_Activated: _Callable[[_struct.EventRegistrationToken],  # token
                                _type.HRESULT]
    add_Closed: _Callable[[_Windows_Foundation.ITypedEventHandler[_inspectable.IInspectable, IWindowEventArgs],  # handler
                           _Pointer[_struct.EventRegistrationToken]],  # token
                          _type.HRESULT]
    remove_Closed: _Callable[[_struct.EventRegistrationToken],  # token
                             _type.HRESULT]
    add_SizeChanged: _Callable[[_Windows_Foundation.ITypedEventHandler[_inspectable.IInspectable, IWindowSizeChangedEventArgs],  # handler
                                _Pointer[_struct.EventRegistrationToken]],  # token
                               _type.HRESULT]
    remove_SizeChanged: _Callable[[_struct.EventRegistrationToken],  # token
                                  _type.HRESULT]
    add_VisibilityChanged: _Callable[[_Windows_Foundation.ITypedEventHandler[_inspectable.IInspectable, IWindowVisibilityChangedEventArgs],  # handler
                                      _Pointer[_struct.EventRegistrationToken]],  # token
                                     _type.HRESULT]
    ...
    Close: _Callable[[],
                     _type.HRESULT]
    SetTitleBar: _Callable[[IUIElement],  # titleBar
                           _type.HRESULT]
...
class IWindow2(_inspectable.IInspectable):
    ...
    put_SystemBackdrop: _Callable[[_Microsoft_UI_Xaml_Media.ISystemBackdrop],  # value
                                  _type.HRESULT]
    get_AppWindow: _Callable[[_Pointer[_Microsoft_UI_Windowing.IAppWindow]],  # value
                             _type.HRESULT]
...
class IWindowActivatedEventArgs(_inspectable.IInspectable):
    ...
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
    get_WindowActivationState: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.WindowActivationState]],  # value
                                         _type.HRESULT]


class IWindowEventArgs(_inspectable.IInspectable):
    get_Handled: _Callable[[_Pointer[_type.boolean]],  # value
                           _type.HRESULT]
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
...
class IWindowFactory(_inspectable.IInspectable):
    CreateInstance: _Callable[[_inspectable.IInspectable,  # baseInterface
                               _Pointer[_inspectable.IInspectable],  # innerInterface
                               _Pointer[IWindow]],  # value
                              _type.HRESULT]
...
class IWindowVisibilityChangedEventArgs(_inspectable.IInspectable):
    get_Handled: _Callable[[_Pointer[_type.boolean]],  # value
                           _type.HRESULT]
    put_Handled: _Callable[[_type.boolean],  # value
                           _type.HRESULT]
...
class IXamlResourceReferenceFailedEventArgs(_inspectable.IInspectable):
    get_Message: _Callable[[_Pointer[_type.HSTRING]],  # value
                           _type.HRESULT]
...
class IXamlRoot2(_inspectable.IInspectable):
    get_ContentIslandEnvironment: _Callable[[_Pointer[_Microsoft_UI_Content.IContentIslandEnvironment]],  # value
                                            _type.HRESULT]
...
class IXamlServiceProvider(_inspectable.IInspectable):
    GetService: _Callable[[_struct.Windows.UI.Xaml.Interop.TypeName,  # type
                           _Pointer[_inspectable.IInspectable]],  # result
                          _type.HRESULT]
