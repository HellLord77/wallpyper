...
class INotifyCollectionChangedEventArgs(_inspectable.IInspectable):
    get_Action: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction]],  # value
                          _type.HRESULT]
...
class INotifyCollectionChangedEventArgsFactory(_inspectable.IInspectable):
    CreateInstanceWithAllParameters: _Callable[[_enum.Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction,  # action
