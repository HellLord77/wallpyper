...
class IBitmapImage(_inspectable.IInspectable):
    get_CreateOptions: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Media.Imaging.BitmapCreateOptions]],  # value
                                 _type.HRESULT]
    put_CreateOptions: _Callable[[_enum.Microsoft.UI.Xaml.Media.Imaging.BitmapCreateOptions],  # value
                                 _type.HRESULT]
    ...
    put_DecodePixelHeight: _Callable[[_type.INT32],  # value
                                     _type.HRESULT]
    get_DecodePixelType: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Media.Imaging.DecodePixelType]],  # value
                                   _type.HRESULT]
    put_DecodePixelType: _Callable[[_enum.Microsoft.UI.Xaml.Media.Imaging.DecodePixelType],  # value
                                   _type.HRESULT]
...
class IBitmapImageStatics(_inspectable.IInspectable, factory=True):
    get_CreateOptionsProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                         _type.HRESULT]
    get_UriSourceProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                     _type.HRESULT]
    get_DecodePixelWidthProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                            _type.HRESULT]
    get_DecodePixelHeightProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                             _type.HRESULT]
    get_DecodePixelTypeProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                           _type.HRESULT]
    get_IsAnimatedBitmapProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                            _type.HRESULT]
...
class IBitmapSourceStatics(_inspectable.IInspectable, factory=True):
    get_PixelWidthProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                      _type.HRESULT]
    get_PixelHeightProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                       _type.HRESULT]
...
class IRenderTargetBitmap(_inspectable.IInspectable):
    ...
    get_PixelHeight: _Callable[[_Pointer[_type.INT32]],  # value
                               _type.HRESULT]
    RenderAsync: _Callable[[_Microsoft_UI_Xaml.IUIElement,  # element
                            _Pointer[_Windows_Foundation.IAsyncAction]],  # operation
                           _type.HRESULT]
    RenderToSizeAsync: _Callable[[_Microsoft_UI_Xaml.IUIElement,  # element
...
class ISvgImageSource(_inspectable.IInspectable):
    ...
    remove_OpenFailed: _Callable[[_struct.EventRegistrationToken],  # token
                                 _type.HRESULT]
    SetSourceAsync: _Callable[[_Windows_Storage_Streams.IRandomAccessStream,  # streamSource
                               _Pointer[_Windows_Foundation.IAsyncOperation[_enum.Microsoft.UI.Xaml.Media.Imaging.SvgImageSourceLoadStatus]]],  # operation
                              _type.HRESULT]
...
class ISvgImageSourceFailedEventArgs(_inspectable.IInspectable):
    get_Status: _Callable[[_Pointer[_enum.Microsoft.UI.Xaml.Media.Imaging.SvgImageSourceLoadStatus]],  # value
                          _type.HRESULT]
...
class ISvgImageSourceStatics(_inspectable.IInspectable, factory=True):
    get_UriSourceProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                     _type.HRESULT]
    get_RasterizePixelWidthProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                               _type.HRESULT]
    get_RasterizePixelHeightProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                                _type.HRESULT]
