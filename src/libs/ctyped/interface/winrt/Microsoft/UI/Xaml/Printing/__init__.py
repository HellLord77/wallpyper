...
from .....Windows.Graphics import Printing as _Windows_Graphics_Printing
...
class IPrintDocument(_inspectable.IInspectable):
    ...
    remove_AddPages: _Callable[[_struct.EventRegistrationToken],  # token
                               _type.HRESULT]
    AddPage: _Callable[[_Microsoft_UI_Xaml.IUIElement],  # pageVisual
                       _type.HRESULT]
    AddPagesComplete: _Callable[[],
                                _type.HRESULT]
    SetPreviewPageCount: _Callable[[_type.INT32,  # count
                                    _enum.Microsoft.UI.Xaml.Printing.PreviewPageCountType],  # type
                                   _type.HRESULT]
    SetPreviewPage: _Callable[[_type.INT32,  # pageNumber
                               _Microsoft_UI_Xaml.IUIElement],  # pageVisual
                              _type.HRESULT]
...
class IPrintDocumentStatics(_inspectable.IInspectable, factory=True):
    get_DocumentSourceProperty: _Callable[[_Pointer[_Microsoft_UI_Xaml.IDependencyProperty]],  # value
                                          _type.HRESULT]
