...
class _IClosableNotifierHandler:
    Invoke: _Callable[[],
                      _type.HRESULT]


class IClosableNotifierHandler(_IClosableNotifierHandler, _Unknwnbase.IUnknown):
    pass


# noinspection PyPep8Naming
class IClosableNotifierHandler_impl(_IClosableNotifierHandler, _Unknwnbase.IUnknown_impl):
    pass


class IClosableNotifier(_inspectable.IInspectable):
    get_IsClosed: _Callable[[_Pointer[_type.boolean]],  # value
                            _type.HRESULT]
    add_Closed: _Callable[[IClosableNotifierHandler,  # handler
                           _Pointer[_struct.EventRegistrationToken]],  # token
                          _type.HRESULT]
    remove_Closed: _Callable[[_struct.EventRegistrationToken],  # token
                             _type.HRESULT]
    add_FrameworkClosed: _Callable[[IClosableNotifierHandler,  # handler
                                    _Pointer[_struct.EventRegistrationToken]],  # token
                                   _type.HRESULT]
    remove_FrameworkClosed: _Callable[[_struct.EventRegistrationToken],  # token
                                      _type.HRESULT]
